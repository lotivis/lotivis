...
(function (global, factory) {
  ...
  var LotivisError = /*#__PURE__*/function (_Error) {
    _inherits(LotivisError, _Error);

    var _super = _createSuper(LotivisError);

    function LotivisError(message) {
      var _this;

      _classCallCheck(this, LotivisError);
    ...
    return _createClass(LotivisError);
  }( /*#__PURE__*/_wrapNativeSuper(Error));
  var LotivisElementNotFoundError = /*#__PURE__*/function (_LotivisError) {
    _inherits(LotivisElementNotFoundError, _LotivisError);

    var _super2 = _createSuper(LotivisElementNotFoundError);

    function LotivisElementNotFoundError(selector) {
      _classCallCheck(this, LotivisElementNotFoundError);

      return _super2.call(this, "Can't find an element with ID '".concat(selector, "'."));
    }

    return _createClass(LotivisElementNotFoundError);
  }(LotivisError);
  var DataValidateError = /*#__PURE__*/function (_LotivisError2) {
    _inherits(DataValidateError, _LotivisError2);

    var _super3 = _createSuper(DataValidateError);

    function DataValidateError() {
      _classCallCheck(this, DataValidateError);

      return _super3.apply(this, arguments);
    }

    return _createClass(DataValidateError);
  }(LotivisError);
  var MissingPropertyError = /*#__PURE__*/function (_DataValidateError) {
    _inherits(MissingPropertyError, _DataValidateError);

    var _super4 = _createSuper(MissingPropertyError);

    function MissingPropertyError(message, data) {
      var _this2;

      _classCallCheck(this, MissingPropertyError);

      _this2 = _super4.call(this, message + " " + JSON.stringify(data || {}));
      _this2.data = data;
      return _this2;
    }

    return _createClass(MissingPropertyError);
  }(DataValidateError);
  var InvalidFormatError = /*#__PURE__*/function (_DataValidateError2) {
    _inherits(InvalidFormatError, _DataValidateError2);

    var _super5 = _createSuper(InvalidFormatError);
  ...
  var LotivisUnimplementedMethodError = /*#__PURE__*/function (_LotivisError4) {
    _inherits(LotivisUnimplementedMethodError, _LotivisError4);

    var _super7 = _createSuper(LotivisUnimplementedMethodError);

    function LotivisUnimplementedMethodError(functionName) {
      _classCallCheck(this, LotivisUnimplementedMethodError);

      return _super7.call(this, "Subclasses must override function '".concat(functionName, "'."));
    }

    return _createClass(LotivisUnimplementedMethodError);
  }(LotivisError);
  ...
  function powish(transform) {
    ...
    function rescale() {
      return exponent === 1 ? transform(identity$4, identity$4) : exponent === 0.5 ? transform(transformSqrt, transformSquare) : transform(transformPow(exponent), transformPow(1 / exponent));
    }
  ...
  var Component = /*#__PURE__*/function () {
    ...
    _createClass(Component, [{
      key: "initializeFromSelector",
      value: function initializeFromSelector(selector) {
        this.selector = selector;
        this.parent = select("#" + selector);
        if (this.parent.empty()) throw new LotivisElementNotFoundError(selector);
      }
    }, {
      key: "initializeFromConfig",
      value: function initializeFromConfig(config) {
        this.config = config;

        if (config.selector) {
          this.initializeFromSelector(config.selector);
        } else {
          var selector = camel2title(this.constructor.name).toLowerCase().trim().split(" ").join("-");
          this.initializeFromSelector(selector);
        }
      }
    }, {
      key: "initializeFromParent",
      value: function initializeFromParent(parent) {
      ...
      key: "getElementEffectiveSize",
      value: function getElementEffectiveSize() {
      ...
      value: function getElementPosition() {
        ...
        var xPosition = rect.x + window.scrollX;
      ...
      value: function toString() {
        var components = [this.constructor.name];
        if (this.selector) components.push("'".concat(this.selector, "'"));
      ...
      value: function getClassname() {
        if (!this.constructor || !this.constructor.name) return _typeof(this);
  ...
  var alreadyLogged = [];
  var lotivis_log_once = function lotivis_log_once(message) {
    if (alreadyLogged.includes(message)) return;
    alreadyLogged.push(message);
    console.warn("[lotivis]  Warning only once: ".concat(message));
  };
  exports.lotivis_log = function lotivis_log() {
    return null;
  };
  /**
  ...
  function debug(enabled) {
    var printConfig = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
    exports.lotivis_log = enabled ? console.log : function () {
      return null;
    };
    exports.lotivis_log("[lotivis]  ".concat(enabled ? "En" : "Dis", "abled debug mode."));
    if (!printConfig) return;
    exports.lotivis_log("LotivisConfig = ".concat(JSON.stringify(LotivisConfig, null, 2)));
  }
  ...
  var Chart = /*#__PURE__*/function (_Component) {
    ...
    function Chart(parent, config) {
      ...
      _this.svgSelector = (_this.selector || createID()) + "-svg";
      _this.element = _this.parent;

      _this.element.attr("id", _this.selector);

      _this.config = config || {};
      _this.updateSensible = true;

      _this.initialize();

      if (_this.config.datasets) {
        _this.setDatasets(_this.config.datasets);
      } else {
        _this.update();
      }
    ...
    _createClass(Chart, [{
      ...
      key: "update",
      value: function update(datasetsController, reason) {
      ...
      key: "makeUpdateInsensible",
      value: function makeUpdateInsensible() {
      ...
      key: "makeUpdateSensible",
      value: function makeUpdateSensible() {
  ...
  var DateChartAxisRenderer = /*#__PURE__*/_createClass(
  /**
   * Creates a new instance of DateChartAxisRenderer.
   *
   * @param dateChart The parental date.chart chart.
   */
  function DateChartAxisRenderer(dateChart) {
    _classCallCheck(this, DateChartAxisRenderer);

    /**
     * Appends the `left` and `bottom` axis to the date.chart chart.
     */
    this.render = function () {
      var height = dateChart.config.height;
      var margin = dateChart.config.margin; // left axis

      dateChart.svg.append("g").call(axisLeft(dateChart.yChart)).attr("transform", function () {
        return "translate(".concat(margin.left, ",0)");
      }); // bottom axis

      dateChart.svg.append("g").call(axisBottom(dateChart.xChartScale)).attr("transform", function () {
        return "translate(0,".concat(height - margin.bottom, ")");
      });
    };
  });
   ...
   */
  var TimeChartLabelRenderer = /*#__PURE__*/_createClass(
  /**
   * Creates a new instance of TimeChartLabelRenderer.
   * @param dateChart The parental date.chart chart.
   */
  function TimeChartLabelRenderer(dateChart) {
    _classCallCheck(this, TimeChartLabelRenderer);
    ...
    this.renderBarLabels = function (stack) {
      var xChartRef = dateChart.xChartScale;
      var yChartRef = dateChart.yChart;
      var xStackRef = dateChart.xStack;
      var numberFormat = dateChart.config.numberFormat;
      var labelColor = dateChart.config.labelColor;
      var numberOfSeries = stack.length;
      var seriesIndex = 0;
      var bandwidth = xStackRef.bandwidth() / 2;
      dateChart.svg.append("g").selectAll('g').data(stack).enter().append('g').attr('fill', labelColor).selectAll('.text').data(function (dataset) {
        return dataset;
      }).enter().append('text').attr('class', 'lotivis-date.chart-chart-label').attr("transform", function (item) {
        var x = xChartRef(item.data.date) + xStackRef(stack.label) + bandwidth;
        var y = yChartRef(item[1]) - 5;
        return "translate(".concat(x, ",").concat(y, ")rotate(-60)");
  ...
  function sumOfDataset(flatData, dataset) {
    return sumOfValues(flatData.filter(function (item) {
  ...
  var Color$1 = /*#__PURE__*/function () {
    ...
    function Color(r, g, b) {
      ...
      if ((r || r === 0) && (g || g === 0) && (b || b === 0)) {
        ...
        throw new Error("Invalid argument: ".concat(r));
      }
    }

    _createClass(Color, [{
      key: "initialize",
      value: function initialize(r, g, b) {
        this.r = Math.round(r);
        this.g = Math.round(g);
        this.b = Math.round(b);
      }
      ...
      key: "colorAdding",
      value: function colorAdding(r, g, b) {
        return new Color(this.r + r, this.g + g, this.b + b);
      } // MARK: - Statics

    }], [{
      key: "mapColors",
      value: function mapColors(till) {
        return linear().domain([0, 1 / 3 * till, 2 / 3 * till, till]).range(["yellow", "orange", "red", "purple"]);
      }
    }, {
      key: "plotColor",
      value: function plotColor(till) {
        return Color.mapColors(till); // return d3
        //   .scaleLinear()
  ...
  Color$1.colorsForStack = function (stackNumber) {
    var amount = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 1;
    var colorCouple = Color$1.stackColors[stackNumber % Color$1.stackColors.length];
    var colorGenerator = linear().domain([0, amount]).range([colorCouple[0], colorCouple[1]]);
    var colors = [];
  ...
  var TimeChartLegendRenderer = /*#__PURE__*/_createClass(function TimeChartLegendRenderer(dateChart) {
    _classCallCheck(this, TimeChartLegendRenderer);
    ...
    function renderDefaultLegend() {
      var config = dateChart.config;
      var controller = dateChart.datasetController;
      var numberFormat = dateChart.config.numberFormat;
      var datasets = controller.datasets;
      var datasetNames = controller.labels;
      var circleRadius = 6;
      var labelMargin = 50;
      var xLegend = band().domain(datasetNames).rangeRound([config.margin.left, config.width - config.margin.right]);
      var legends = dateChart.graph.selectAll(".legend").data(datasets).enter();
      legends.append("text").attr("class", "lotivis-date.chart-chart-legend-label").attr("font-size", 13).attr("x", function (item) {
        return xLegend(item.label) - 30;
      }).attr("y", dateChart.graphHeight + labelMargin).style("cursor", "pointer").style("fill", function (item) {
        return controller.getColorForDataset(item.label);
      }).text(function (item) {
        var value = controller.getSumOfDataset(item.label);
        var formatted = numberFormat.format(value);
        return "".concat(item.label, " (").concat(formatted, ")");
      }).on("click", function (event) {
        if (!event || !event.target) return;
        if (!event.target.innerHTML) return;
        var components = event.target.innerHTML.split(" (");
        components.pop();
        var label = components.join(" (");
        console.log("label", label);
        dateChart.toggleDataset(label);
      }.bind(this));
      legends.append("circle").attr("class", "lotivis-date.chart-chart-legend-circle").attr("r", circleRadius).attr("cx", function (item) {
        return xLegend(item.label) - circleRadius * 2 - 30;
      }).attr("cy", dateChart.graphHeight + labelMargin - circleRadius + 2).style("stroke", function (item) {
        return controller.getColorForDataset(item.label);
    ...
    function renderCombinedStacksLegend() {
      var stackNames = dateChart.datasetController.stacks;
      var numberFormat = dateChart.config.numberFormat;
      var circleRadius = 6;
      var labelMargin = 50;
      var xLegend = band().domain(stackNames).rangeRound([dateChart.config.margin.left, dateChart.config.width - dateChart.config.margin.right]);
      var legends = dateChart.graph.selectAll(".lotivis-date.chart-chart-legend-label").data(stackNames).enter();
      legends.append("text").attr("class", "lotivis-date.chart-chart-legend-label").attr("font-size", 23).attr("x", function (item) {
        ...
        var value = sumOfStack(dateChart.datasetController.flatData, item);
        var formatted = numberFormat.format(value);
        ...
        return "".concat(text, " (").concat(formatted, ")");
      }.bind(this));
      legends.append("circle").attr("r", circleRadius).attr("cx", function (item) {
        return xLegend(item) - circleRadius * 2 - 30;
      }).attr("cy", dateChart.graphHeight + labelMargin - circleRadius + 2).style("cursor", "pointer").style("stroke", function (item, index) {
        return Color$1.colorsForStack(index)[0].rgbString();
  ...
  var TimeChartBarsRenderer = /*#__PURE__*/_createClass(
  /**
   * Creates a new instance of TimeChartBarsRenderer.
   * @param dateChart The parental date.chart chart.
   */
  function TimeChartBarsRenderer(dateChart) {
    _classCallCheck(this, TimeChartBarsRenderer);
    ...
    this.renderBars = function (stack) {
      ...
      var config = dateChart.config || {};
      var isCombineStacks = config.combineStacks || false;
      var colors = dateChart.datasetController.getColorsForStack(stack.stack) || Color.defaultTint;
      var barRadius = config.barRadius || LotivisConfig.barRadius;
      dateChart.svg.append("g").selectAll("g").data(stack.series).enter().append("g").attr("fill", function (stackData, index) {
        return isCombineStacks ? colors[0] : stack.colors[index];
      }).selectAll("rect").data(function (serie) {
        return serie;
      }).enter().append("rect").attr("class", "ltv-date-chart-bar").attr("rx", isCombineStacks ? 0 : barRadius).attr("ry", isCombineStacks ? 0 : barRadius).attr("x", function (item) {
        return dateChart.xChartScale(item.data.date) + dateChart.xStack(stack.label);
      }).attr("y", function (d) {
        return dateChart.yChart(d[1]);
      }).attr("width", dateChart.xStack.bandwidth()).attr("height", function (d) {
        return dateChart.yChart(d[0]) - dateChart.yChart(d[1]);
      });
    };
  });
  ...
  var TimeChartHoverBarsRenderer = /*#__PURE__*/_createClass(
  /**
   * Creates a new instance of TimeChartHoverBarsRenderer.
   *
   * @param dateChart
   */
  function TimeChartHoverBarsRenderer(dateChart) {
    _classCallCheck(this, TimeChartHoverBarsRenderer);

    function createID(date) {
      return "ltv-date-chart-hover-bar-id-".concat(toSaveID(String(date)));
    }
    ...
    function onMouseEnter(event, date) {
      this.hideAll();
      dateChart.svg.select("#".concat(createID(date))).attr("opacity", 0.3);
    ...
    this.renderGhostBars = function () {
      ...
      var dates = dateChart.config.dateLabels || dateChart.dataview.dates;
      dateChart.svg.append("g").selectAll("rect").data(dates).enter().append("rect").attr("class", "ltv-date-chart-hover-bar").attr("id", function (date) {
        return createID(date);
      }).attr("opacity", 0).attr("x", function (date) {
        return dateChart.xChartScale(date);
      }).attr("y", margin.top).attr("width", dateChart.xChartScale.bandwidth()).attr("height", config.height - margin.bottom - margin.top).on("mouseenter", onMouseEnter.bind(this)).on("mouseout", onMouserOut.bind(this)).on("mousedrag", onMouserOut.bind(this)).on("click", onMouseClick.bind(this));
    };
  });
  ...
  function combine(flattenList) {
    var combined = [];
    var copiedList = copy(flattenList);

    var _loop = function _loop(index) {
      var listItem = copiedList[index];
      var entry = combined.find(function (entryItem) {
      ...
      if (entry) {
        ...
        var _entry = {};
        if (isValue(listItem.label)) _entry.label = listItem.label;
        if (isValue(listItem.dataset)) _entry.dataset = listItem.dataset;
        if (isValue(listItem.stack)) _entry.stack = listItem.stack;
        if (isValue(listItem.location)) _entry.location = listItem.location;
        if (isValue(listItem.locationTotal)) _entry.locationTotal = listItem.locationTotal;
        if (isValue(listItem.date)) _entry.date = listItem.date;
        if (isValue(listItem.dateTotal)) _entry.dateTotal = listItem.dateTotal;
        if (isValue(listItem.locationName)) _entry.locationName = listItem.locationName;
        _entry.value = listItem.value || 0;
        combined.push(_entry);
      }
    };

    for (var index = 0; index < copiedList.length; index++) {
      _loop(index);
    }
  ...
  function combineByStacks(flattenList) {
    ...
    var _loop2 = function _loop2(index) {
      var listItem = flattenList[index];
      var entry = combined.find(function (entryItem) {
      ...
      if (entry) {
        ...
        var _entry2 = {};
        if (isValue(listItem.label)) _entry2.label = listItem.label;
        if (isValue(listItem.dataset)) _entry2.dataset = listItem.dataset;
        if (isValue(listItem.stack)) _entry2.stack = listItem.stack;
        if (isValue(listItem.location)) _entry2.location = listItem.location;
        if (isValue(listItem.locationTotal)) _entry2.locationTotal = listItem.locationTotal;
        if (isValue(listItem.date)) _entry2.date = listItem.date;
        if (isValue(listItem.dateTotal)) _entry2.dateTotal = listItem.dateTotal;
        if (isValue(listItem.locationName)) _entry2.locationName = listItem.locationName;
        _entry2.value = listItem.value || 0;
        combined.push(_entry2);
      }
    };

    for (var index = 0; index < flattenList.length; index++) {
      _loop2(index);
    }
  ...
  function combineByDate(flatData) {
    ...
    var _loop3 = function _loop3(index) {
      ...
      if (entry) {
        ...
        var _entry3 = {};
        if (isValue(listItem.label)) _entry3.label = listItem.label;
        if (isValue(listItem.dataset)) _entry3.dataset = listItem.dataset;
        if (isValue(listItem.stack)) _entry3.stack = listItem.stack;
        if (isValue(listItem.date)) _entry3.date = listItem.date;
        if (isValue(listItem.dateTotal)) _entry3.dateTotal = listItem.dateTotal;
        _entry3.value = listItem.value || 0;
        combined.push(_entry3);
      }
    };
  ...
  function combineByLocation(flatData) {
    ...
    var _loop4 = function _loop4(index) {
      ...
      if (entry) {
        ...
        var _entry4 = {};
        if (isValue(listItem.label)) _entry4.label = listItem.label;
        if (isValue(listItem.dataset)) _entry4.dataset = listItem.dataset;
        if (isValue(listItem.stack)) _entry4.stack = listItem.stack;
        if (isValue(listItem.location)) _entry4.location = listItem.location;
        if (isValue(listItem.locationTotal)) _entry4.locationTotal = listItem.locationTotal;
        if (isValue(listItem.locationName)) _entry4.locationName = listItem.locationName;
        _entry4.value = listItem.value;
        combined.push(_entry4);
      }
    };
  ...
  var TimeChartTooltipRenderer = /*#__PURE__*/_createClass(
  /**
   * Creates a new instance of TimeChartTooltipRenderer.
   *
   * @constructor
   */
  function TimeChartTooltipRenderer(dateChart) {
    _classCallCheck(this, TimeChartTooltipRenderer);

    var tooltip = dateChart.element.append("div").attr("class", "ltv-tooltip").attr("rx", 5) // corner radius
    ...
    function getTooltipSize() {
      var tooltipWidth = Number(tooltip.style("width").replace("px", ""));
      var tooltipHeight = Number(tooltip.style("height").replace("px", ""));
    ...
    function getTop(factor, offset, tooltipSize) {
      var top = dateChart.config.margin.top * factor;
    ...
    function getXLeft(date, factor, offset, tooltipSize) {
      var x = dateChart.xChartScalePadding(date) * factor;
    ...
    function getXRight(date, factor, offset) {
      var x = dateChart.xChartScalePadding(date) + dateChart.xChartScalePadding.bandwidth();
      x *= factor;
    ...
    function getHTMLForDate(date) {
      var flatData = dateChart.snapshot.flatData.filter(function (item) {
        return "".concat(item.date) === "".concat(date);
      });
      var first = flatData.first();
      var title;

      if (first && first.from && first.till) {
        title = "".concat(first.from, " - ").concat(first.till);
      } else {
        title = "".concat(date);
      }

      var sum = 0;
      var dataHTML = combineByDate(flatData).filter(function (item) {
        return item.value > 0;
      }).map(function (item) {
        var color = dateChart.datasetController.getColorForDataset(item.dataset);
        var divHTML = "<div style=\"background: ".concat(color, ";color: ").concat(color, "; display: inline;\">__</div>");
        var valueFormatted = dateChart.config.numberFormat.format(item.value);
        sum += item.value;
        return "".concat(divHTML, " ").concat(item.dataset, ": <b>").concat(valueFormatted, "</b>");
      }).join("<br>");
      var sumFormatted = dateChart.config.numberFormat.format(sum);
      return "<b>".concat(title, "</b><br>").concat(dataHTML, "<br><br>Sum: <b>").concat(sumFormatted, "</b>");
    }
    /**
    ...
    this.showTooltip = function (event, date) {
      ...
      var html = getHTMLForDate(date);
      tooltip.html(html); // position tooltip

      var tooltipSize = getTooltipSize();
      var factor = dateChart.getElementEffectiveSize()[0] / dateChart.config.width;
      var offset = dateChart.getElementPosition();
      var top = getTop(factor, offset, tooltipSize);
      var left = dateChart.xChartScalePadding(date); // differ tooltip position on bar position
      ...
      tooltip.style("left", "".concat(left, "px")).style("top", "".concat(top, "px")).style("opacity", 1);
    };
    /**
  ...
  var TimeChartGridRenderer = /*#__PURE__*/_createClass(
  /**
   * Creates a new instance of TimeChartGridRenderer.
   *
   * @param dateChart
   */
  function TimeChartGridRenderer(dateChart) {
    _classCallCheck(this, TimeChartGridRenderer);

    /**
     *
     */
    this.createAxis = function () {
      this.xAxisGrid = axisBottom(dateChart.xChartScale).tickSize(-dateChart.graphHeight).tickFormat("");
      this.yAxisGrid = axisLeft(dateChart.yChart).tickSize(-dateChart.graphWidth).tickFormat("").ticks(20);
    };
    /**
     *
     */
    ...
    this.renderGrid = function () {
      ...
      dateChart.svg.append("g").attr("class", "y axis-grid").attr("transform", "translate(".concat(config.margin.left, ",0)")).attr("stroke", color).attr("stroke-width", width).attr("opacity", opacity).call(this.yAxisGrid);
    };
  });
  ...
  var TimeChartSelectionRenderer = /*#__PURE__*/_createClass(
  /**
   * Creates a new instance of TimeChartHoverBarsRenderer.
   * @param dateChart
   */
  function TimeChartSelectionRenderer(dateChart) {
    _classCallCheck(this, TimeChartSelectionRenderer);

    function createID(date) {
      return "ltv-date-chart-selection-rect-id-".concat(toSaveID(String(date)));
    }
    ...
    this.render = function () {
      var margin = dateChart.config.margin;
      var dates = dateChart.config.dateLabels || dateChart.dataview.dates;
      dateChart.svg.append("g").selectAll("rect").data(dates).enter().append("rect").attr("class", "ltv-date-chart-selection-rect").attr("id", function (date) {
        return createID(date);
      }).attr("x", function (date) {
        return dateChart.xChartScale(date);
      }).attr("y", margin.top).attr("opacity", 0).attr("width", dateChart.xChartScale.bandwidth()).attr("height", dateChart.config.height - margin.bottom - margin.top);
    };

    this.update = function () {
      var selectedDates = getSelectedDates();
      dateChart.svg.selectAll(".ltv-date-chart-selection-rect").attr("opacity", function (date) {
        return selectedDates.includes(String(date)) ? 0.15 : 0;
      });
    };
  });

  var DATE_CHART_CONFIG = {
    width: 1000,
    height: 600,
    margin: {
    ...
    dateAccess: function dateAccess(date) {
  ...
  var DateChart = /*#__PURE__*/function (_Chart) {
    _inherits(DateChart, _Chart);

    var _super = _createSuper(DateChart);
    ...
    _createClass(DateChart, [{
      key: "initialize",
      value: // called by `Chart` superclass
      ...
      key: "initializeDefaultValues",
      value: function initializeDefaultValues() {
        var margin, config;
      ...
      value: function precalculate() {
        ...
        var groupSize = this.config.groupSize || 1;
      ...
      value: function createScales() {
        ...
        var dates = config.dateLabels || this.dataview.dates;
        console.log("dates", dates);
        this.xChartScale = band().domain(dates).rangeRound([margin.left, config.width - margin.right]);
        this.xChartScalePadding = band().domain(dates).rangeRound([margin.left, config.width - margin.right]).paddingInner(0.2);
        this.xStack = band().domain(this.dataview.enabledStacks).rangeRound([0, this.xChartScale.bandwidth()]).padding(0.05);
        this.yChart = linear().domain([0, this.dataview.max]).nice().rangeRound([config.height - margin.bottom, margin.top]);
      }
      /**
      ...
      value: function draw() {
        ...
        for (var index = 0; index < this.dataview.datasetStacksPresented.length; index++) {
          var stack = this.dataview.datasetStacksPresented[index];
      ...
      value: function renderSVG() {
        ...
        this.svg = this.element.append("svg").attr("class", "ltv-chart-svg ltv-date-chart-svg").attr("preserveAspectRatio", "xMidYMid meet").attr("viewBox", "0 0 ".concat(this.config.width, " ").concat(this.config.height)).attr("id", this.svgSelector);
        this.background = this.svg.append("rect").attr("width", this.config.width).attr("height", this.config.height).attr("fill", "white").attr("opacity", 0).attr("cursor", "pointer").on("click", function (event, some) {
          _this.datasetController.resetDateFilters();
        });
        this.graph = this.svg.append("g").attr("width", this.graphWidth).attr("height", this.graphHeight).attr("transform", "translate(".concat(this.config.margin.left, ",").concat(this.config.margin.top, ")"));
      }
      /**
      ...
      key: "toggleDataset",
      value: function toggleDataset(label) {
  ...
  var Checkbox = /*#__PURE__*/function (_Component) {
    ...
    _createClass(Checkbox, [{
      ...
      key: "onClick",
      value: function onClick(checked) {
        // empty
  ...
  var UrlParameters = /*#__PURE__*/function () {
    function UrlParameters() {
      _classCallCheck(this, UrlParameters);
    }

    _createClass(UrlParameters, [{
      key: "getURL",
      value:
      /**
      ...
      key: "getBoolean",
      value: function getBoolean(parameter) {
        var defaultValue = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
        var value = this.getURL().searchParams.get(parameter);
        return value ? value === "true" : defaultValue;
      }
    }, {
      key: "getString",
      value: function getString(parameter) {
        var defaultValue = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "";
        return this.getURL().searchParams.get(parameter) || defaultValue;
      }
    }, {
      key: "set",
      value: function set(parameter, newValue) {
        var url = this.getURL();
      ...
      key: "setWithoutDeleting",
      value: function setWithoutDeleting(parameter, newValue) {
        var url = this.getURL();
        url.searchParams.set(parameter, newValue);
        window.history.replaceState(null, null, url);
        this.updateCurrentPageFooter();
      ...
      value: function clear() {
        ...
        var newURL = new URL(newPath);
        window.history.replaceState(null, null, newURL);
        this.updateCurrentPageFooter();
      }
    }, {
      key: "updateCurrentPageFooter",
      value: function updateCurrentPageFooter() {
  ...
  var Button = /*#__PURE__*/function (_Component) {
    ...
    function Button(parent) {
      ...
      _this = _super.call(this, parent);
      _this.element = parent.append("button").attr("id", _this.selector).attr("class", "ltv-button").on("click", function (event) {
    ...
    _createClass(Button, [{
      ...
      key: "onClick",
      value: function onClick(event) {// empty
      }
    }]);
  ...
  var Popup = /*#__PURE__*/function (_Component) {
    ...
    function Popup() {
      ...
      var parent = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : select("body");

      _classCallCheck(this, Popup);

      _this = _super.call(this, parent);

      _this.injectUnderground(parent);

      _this.injectContainer();

      _this.injectCard();

      _this.inject();

      _this.injectCloseButton();

      _this.addCloseActionListeners();
    ...
    _createClass(Popup, [{
      ...
      key: "injectUnderground",
      value: function injectUnderground(parent) {
      ...
      key: "injectCloseButton",
      value: function injectCloseButton() {
      ...
      key: "addCloseActionListeners",
      value: function addCloseActionListeners() {
        var validIDs = [this.closeButton.selector, this.modalBackgroundId];
        var popup = this;
      ...
      key: "willDismiss",
      value: function willDismiss() {// empty
      }
      /**
      ...
      key: "willRemoveDOMElement",
      value: function willRemoveDOMElement() {// empty
      }
      /**
       * Dismisses the popup.
       */
      ...
      key: "calculateBottomCenter",
      value: function calculateBottomCenter(element) {
        var respectWindowScroll = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
        var rect = element.getBoundingClientRect();
  ...
  function appendExtensionIfNeeded(filename, extension) {
    ...
    return filename.endsWith(extension) ? filename : "".concat(filename).concat(extension);
  }
  function createDownloadFilename() {
    var components = [LotivisConfig.downloadFilePrefix];
    var separator = LotivisConfig.filenameSeparator;
  ...
  function getSVGString(svgNode) {
    ...
    var svgString = serializer.serializeToString(svgNode); // Fix root xlink without namespace
    ...
    function getCSSStyles(parentElement) {
      ...
      for (var i = 0; i < nodes.length; i++) {
        ...
        for (var _c = 0; _c < classes.length; _c++) {
          if (!contains("." + classes[_c], selectorTextArr)) {
            selectorTextArr.push("." + classes[_c]);
          }
        }
      } // Extract CSS Rules
  ...
  function svgString2Image(svgString, width, height, callback) {
    ...
    var imageSource = "data:image/svg+xml;base64," + btoa(unescape(encodeURIComponent(svgString)));
  ...
  function getOriginalSizeOfSVG(svgElement) {
    var viewBoxBaseValue = svgElement.viewBox.baseVal;
  ...
  function downloadJSON(jsonString, filename) {
    ...
    var saveFilename = appendExtensionIfNeeded(filename, "json");
  ...
  function downloadCSV(jsonString, filename) {
    ...
    var saveFilename = appendExtensionIfNeeded(filename, "csv");
    downloadBlob(blob, saveFilename);
  }
  /**
  ...
  function downloadImage(selector, filename) {
    ...
    var svgElement = select("#" + selector);
    var node = svgElement.node();
    var size = getOriginalSizeOfSVG(node);
    var svgString = getSVGString(node);
    svgString2Image(svgString, 2 * size[0], 2 * size[1], function (dataURL) {
      // console.log('dataURL:' + dataURL);
      fetch(dataURL).then(function (res) {
        return res.blob();
      }).then(function (dataBlob) {
        var saveFilename = appendExtensionIfNeeded(filename, "png"); // console.log('saveFilename:' + saveFilename);
  ...
  var SettingsPopup = /*#__PURE__*/function (_Popup) {
    _inherits(SettingsPopup, _Popup);

    var _super = _createSuper(SettingsPopup);

    /**
     * Creates a new instance of SettingsPopup.
     */
    function SettingsPopup(parent) {
    ...
    _createClass(SettingsPopup, [{
      ...
      value: function inject() {
        _get(_getPrototypeOf(SettingsPopup.prototype), "inject", this).call(this);

        this.card.setTitle("");
        this.row = this.card.content.append("div").classed("row", true);
        var container = this.row.append("div");
      ...
      key: "screenshotButtonAction",
      value: function screenshotButtonAction() {
        var filename = this.chart.datasetController.getFilename() || "unknown";
        var downloadFilename = createDownloadFilename(filename, "chart");
  ...
  var DateChartCardSettingsPopup = /*#__PURE__*/function (_SettingsPopup) {
    _inherits(DateChartCardSettingsPopup, _SettingsPopup);

    var _super = _createSuper(DateChartCardSettingsPopup);

    function DateChartCardSettingsPopup() {
      _classCallCheck(this, DateChartCardSettingsPopup);

      return _super.apply(this, arguments);
    }

    _createClass(DateChartCardSettingsPopup, [{
      key: "inject",
      value: function inject() {
        _get(_getPrototypeOf(DateChartCardSettingsPopup.prototype), "inject", this).call(this);

        this.injectShowLabelsCheckbox();
        this.injectCombineStacksCheckbox();
      }
    }, {
      key: "injectShowLabelsCheckbox",
      value: function injectShowLabelsCheckbox() {
        var container = this.row.append("div");
        ...
        this.showLabelsCheckbox.onClick = function (checked) {
          ...
          this.chart.update();
          UrlParameters.getInstance().set("showLabels-".concat(this.chart.selector), checked);
        }.bind(this);
      }
    }, {
      key: "injectCombineStacksCheckbox",
      value: function injectCombineStacksCheckbox() {
        var container = this.row.append("div");
        ...
        this.combineStacksCheckbox.onClick = function (checked) {
          ...
          this.chart.update();
          UrlParameters.getInstance().set("combineStacks-".concat(this.chart.selector), checked);
        }.bind(this);
      }
    }, {
      key: "willShow",
    ...
    return DateChartCardSettingsPopup;
  }(SettingsPopup);
  ...
  var Dropdown = /*#__PURE__*/function (_Component) {
    ...
    function Dropdown(parent) {
      ...
      _this = _super.call(this, parent);
      _this.inputElements = [];
      _this.selector = createID();
      _this.element = parent.append("div").classed("lotivis-dropdown-container", true);
      _this.selectId = createID();
    ...
    _createClass(Dropdown, [{
      ...
      key: "addOption",
      value: function addOption(optionId, optionName) {
      ...
      value: function setOptions(options) {
        ...
        for (var i = 0; i < options.length; i++) {
          ...
          var inputElement = this.addOption(name, name);
      ...
      key: "removeAllInputs",
      value: function removeAllInputs() {
      ...
      key: "onChange",
      value: function onChange(argument) {
      ...
      value: function setSelectedOption(optionID) {
  ...
  Dropdown.create = function (selector, options, selectedOption, onChange) {
    var div = d3.select("#".concat(selector));
    var dropdown = new Dropdown(div);
  ...
  var Option = /*#__PURE__*/_createClass(
  /**
  ...
  var ChartCard = /*#__PURE__*/function (_Card) {
    _inherits(ChartCard, _Card);
     ...
     */
    function ChartCard(parent, config) {
      var _this;
      ...
      _this.injectRadioGroup();

      _this.injectChart();

      var cardSelector = _this.selector;

      _this.setTitle(config && config.title ? config.title : cardSelector || "No Title");
    ...
    _createClass(ChartCard, [{
      ...
      key: "injectRadioGroup",
      value: function injectRadioGroup() {
        this.dropdown = new Dropdown(this.headerCenterComponent);

        this.dropdown.onChange = function (value) {
          var dataset = this.datasets.find(function (dataset) {
            if (!dataset.label) return false;
            return dataset.label.split(" ").join("-") === value;
          });
          dataset = this.datasets.find(function (dataset) {
            return dataset.label === value;
          });
          if (!dataset) return exports.lotivis_log("Can't find dataset with label ".concat(value));
      ...
      key: "updateRadioGroup",
      value: function updateRadioGroup() {
        if (!this.datasets) return;
        var names = this.datasets.map(function (dataset) {
          return dataset.label || "Unknown Label";
        });
      ...
      value: function setDataset(dataset) {
        exports.lotivis_log("this.chart: " + this.chart);
        exports.lotivis_log("this.chart: ", dataset);
        ...
        if (this.onSelectedDatasetChanged) {
          var datasetLabel = dataset.stack || dataset.label || "Unknown";
      ...
      key: "presentSettingsPopupAction",
      value: function presentSettingsPopupAction() {
      ...
      key: "onSelectedDatasetChanged",
      value: function onSelectedDatasetChanged() {
  ...
  var DateChartCard = /*#__PURE__*/function (_ChartCard) {
    _inherits(DateChartCard, _ChartCard);

    var _super = _createSuper(DateChartCard);
     ...
     * @param config
     */
    function DateChartCard(selector) {
      var _this;

      var config = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};

      _classCallCheck(this, DateChartCard);

      var theSelector = selector || config.selector || "date-chart-card";
      _this = _super.call(this, theSelector, config);
      _this.selector = theSelector;
      _this.datasets = [];
      return _this;
    }
    /**
    ...
    _createClass(DateChartCard, [{
      ...
      value: function applyURLParameters() {
        var parameters = UrlParameters.getInstance();
        this.chart.config.showLabels = parameters.getBoolean("showLabels-".concat(this.chartID), this.chart.config.showLabels);
        this.chart.config.combineStacks = parameters.getBoolean("combineStacks-".concat(this.chartID), this.chart.config.combineStacks);
      }
      /**
      ...
      key: "presentSettingsPopupAction",
      value: function presentSettingsPopupAction() {
        var button = document.getElementById(this.moreButton.selector);
        var settingsPopup = new DateChartCardSettingsPopup();
      ...
      key: "screenshotButtonAction",
      value: function screenshotButtonAction() {
        var filename = this.chart.datasetController.getFilename() || "date.chart-chart";
        var downloadFilename = createDownloadFilename(filename, "date-chart");
        downloadImage(this.chart.svgSelector, downloadFilename);
      }
    }]);

    return DateChartCard;
  }(ChartCard);
  ...
  function removeFeatures(geoJSON, removeCandidates) {
    ...
    var _loop = function _loop(index) {
      var code = removeCandidates[index];
      var candidate = newGeoJSON.features.find(function (feature) {
        return feature.properties.code === code;
      });
      if (!candidate) return "continue";
      var candidateIndex = newGeoJSON.features.indexOf(candidate);
      if (candidateIndex < 0) return "continue";
      newGeoJSON.features.splice(candidateIndex, 1);
    };

    for (var index = 0; index < removeCandidates.length; index++) {
  ...
  var MapTooltipRenderer = /*#__PURE__*/_createClass(
  /**
   * Creates a new instance of MapTooltipRenderer.
   * @param mapChart The parental map.chart chart.
   */
  function MapTooltipRenderer(mapChart) {
    _classCallCheck(this, MapTooltipRenderer);

    this.mapChart = mapChart;
    var tooltip = mapChart.element.append("div").attr("class", "ltv-tooltip").attr("rx", 5) // corner radius
    .attr("ry", 5).style("opacity", 0);

    function featureMapID(feature) {
      return "lotivis-map-area-".concat(feature.lotivisId);
    }

    function htmlTitle(features) {
      if (features.length > 3) {
        var featuresSlice = features.slice(0, 3);
        var ids = featuresSlice.map(function (feature) {
          return "".concat(feature.lotivisId);
        }).join(", ");
        var names = featuresSlice.map(mapChart.config.featureNameAccessor).join(", ");
        var moreCount = features.length - 3;
        return "IDs: ".concat(ids, " (+").concat(moreCount, ")<br>Names: ").concat(names, " (+").concat(moreCount, ")");
      } else {
        var _ids = features.map(function (feature) {
          return "".concat(feature.lotivisId);
        }).join(", ");

        var _names = features.map(mapChart.config.featureNameAccessor).join(", ");

        return "IDs: ".concat(_ids, "<br>Names: ").concat(_names);
      }
    }
    ...
    function htmlValues(features) {
      ...
      var flatData = mapChart.datasetController.flatData;
      var combined = combineByLocation(flatData);
      var combinedByLabel = {};

      var _loop = function _loop(i) {
        var feature = features[i];
        var data = combined.filter(function (item) {
          return equals(item.location, feature.lotivisId);
        });

        for (var index = 0; index < data.length; index++) {
          var item = data[index];

          var _label = item.label || item.dataset || item.stack;

          if (combinedByLabel[_label]) {
            combinedByLabel[_label] += item.value;
          } else {
            combinedByLabel[_label] = item.value;
          }
        }
      ...
      for (var label in combinedByLabel) {
    ...
    function getTooltipSize() {
      var tooltipWidth = Number(tooltip.style("width").replace("px", "") || 200);
      var tooltipHeight = Number(tooltip.style("height").replace("px", ""));
    ...
    function positionTooltip(event, feature) {
      // position tooltip
      var tooltipSize = getTooltipSize();
      var projection = mapChart.projection;
      var featureBounds = bounds$1(feature);
      var featureLowerLeft = projection(featureBounds[0]);
      var featureUpperRight = projection(featureBounds[1]);
      var featureBoundsWidth = featureUpperRight[0] - featureLowerLeft[0]; // svg is presented in dynamic sized view box so we need to get the actual size
      // of the element in order to calculate a scale for the position of the tooltip.

      var effectiveSize = mapChart.getElementEffectiveSize();
      var factor = effectiveSize[0] / mapChart.config.width;
      var positionOffset = mapChart.getElementPosition();
      /**
      ...
      function getTooltipLocationAbove() {
        var top = featureUpperRight[1] * factor;
        top -= tooltipSize[1];
      ...
      function getTooltipLocationUnder() {
        var top = featureLowerLeft[1] * factor;
        top += positionOffset[1];
        top += LotivisConfig.tooltipOffset;
        return top;
      }
    ...
    this.mouseOut = function (event, feature) {
      var style = styleForCSSClass(".lotivis-map.chart-area");
      var mapID = featureMapID(feature);
      mapChart.svg.select("#".concat(mapID)).style("stroke", style.stroke || "black").style("stroke-width", style["stroke-width"] || "0.7").style("stroke-dasharray", function (feature) {
  ...
  var MapLegendRenderer = /*#__PURE__*/_createClass(
  /**
   * Creates a new instance of MapLegendRenderer.
   *
   * @param mapChart The parental map.chart chart.
   */
  function MapLegendRenderer(mapChart) {
    _classCallCheck(this, MapLegendRenderer);
    ...
    this.render = function () {
      ...
      var stackNames = mapChart.dataview.stacks;
      var combinedData = mapChart.dataview.combinedData;
      appendLegend();
      legend.raise();
      removeDatasetLegend();

      var _loop = function _loop(index$1) {
        var stackName = stackNames[index$1];
        var dataForStack = combinedData.filter(function (data) {
          return data.stack === stackName;
        });
        var max = max$3(dataForStack, function (item) {
          return item.value;
        }) || 0;
        var offset = index$1 * 80;
        var color = Color$1.colorsForStack(index$1, 1)[0];
        var steps = 4;
        var data = [0, 1 / 4 * max, 1 / 2 * max, 3 / 4 * max, max];
        var generator = Color$1.mapColors(max);
        ...
        legend.append("g").selectAll("text").data(["No Data"]).enter().append("text").attr("class", "ltv-map-chart-legend-text").attr("x", offset + 35).attr("y", 44).text(function (d) {
          return d;
        });
        ...
        legend.append("g").selectAll("text").data([0]).enter().append("text").attr("class", "lotivis-location-chart-legend-text").attr("x", offset + 35).attr("y", 64).text(function (d) {
          return d;
        });
        ...
        legend.append("g").selectAll("rect").data(data).enter().append("rect").attr("class", "ltv-map-chart-legend-rect").style("fill", generator).attr("x", offset + 10).attr("y", function (d, i) {
          return i * 20 + 70;
        }).attr("width", 18).attr("height", 18).style("stroke", "black").style("stroke-width", 1);
        legend.append("g").selectAll("text").data(data).enter().append("text").attr("class", "ltv-map-chart-legend-text").attr("x", offset + 35).attr("y", function (d, i) {
          return i * 20 + 84;
        }).text(function (d, i) {
          if (d === 0) {
            return "> 0";
      ...
      for (var index$1 = 0; index$1 < stackNames.length; index$1++) {
        var _ret = _loop(index$1);
  ...
  var MapLabelRenderer = /*#__PURE__*/_createClass(
  /**
   * Creates a new instance of MapLabelRenderer.
   * @param mapChart The parental map.chart chart.
   */
  function MapLabelRenderer(mapChart) {
    _classCallCheck(this, MapLabelRenderer);
    ...
    this.render = function () {
      removeLabels();
      var geoJSON = mapChart.geoJSON;
      if (!mapChart.geoJSON) return exports.lotivis_log("[lotivis]  No GeoJSON to render (".concat(mapChart.selector, ")."));
      var dataview = mapChart.dataview;
      if (!dataview) return exports.lotivis_log("[lotivis]  No dataview in map chart (".concat(mapChart.selector, ")."));
      if (!mapChart.config.showLabels) return exports.lotivis_log("[lotivis]  Skip rendering labels due to configuration (".concat(mapChart.selector, ")."));
      mapChart.svg.selectAll("text").data(geoJSON.features).enter().append("text").attr("class", "ltv-map-chart-label").text(function (feature) {
        var featureID = mapChart.config.featureIDAccessor(feature);
        var dataset = dataview.combinedData.find(function (dataset) {
          return equals(dataset.location, featureID);
        });
  ...
  var MapDatasetRenderer = /*#__PURE__*/_createClass(
  /**
   * Creates a new instance of MapDatasetRenderer.
   * @param mapChart The parental map.chart chart.
   */
  function MapDatasetRenderer(mapChart) {
    _classCallCheck(this, MapDatasetRenderer);

    var generator = Color$1.mapColors(1);
    var styleArea = styleForCSSClass("ltv-map-chart-area");
    ...
    function featureMapID(feature) {
      return "ltv-map-chart-area-id-".concat(feature.lotivisId);
    }
    /**
    ...
    this.mouseEnter = function (event, feature) {
      ...
      var mapID = featureMapID(feature);
      mapChart.svg.selectAll("#".concat(mapID)).raise().classed("ltv-map-chart-area-hover", true); // .style('stroke', styleHover.stroke || color)
    ...
    this.render = function () {
      if (!mapChart.geoJSON) return exports.lotivis_log("[lotivis]  No GeoJSON to render.");
      if (!mapChart.dataview) return exports.lotivis_log("[lotivis]  No data view property.");
      var stackNames = mapChart.dataview.stacks;
      var combinedData = mapChart.dataview.combinedData;
      resetAreas();
      ...
      var _loop = function _loop(index$1) {
        ...
        var _loop2 = function _loop2(_index) {
          var datasetEntry = dataForStack[_index];
          var locationID = datasetEntry.location;
          var opacity = Number(datasetEntry.value / max);
          mapChart.svg.selectAll(".ltv-map-chart-area").filter(function (item) {
            return equals(mapChart.config.featureIDAccessor(item), locationID);
          }).style("fill", function () {
            if (opacity === 0) {
              return "WhiteSmoke";
            } else {
        ...
        for (var _index = 0; _index < dataForStack.length; _index++) {
          _loop2(_index);
        }
  ...
  var MapGeoJSONRenderer = /*#__PURE__*/_createClass(
  /**
   * Creates a new instance of MapGeoJSONRenderer.
   * @param mapChart The parental map.chart chart.
   */
  function MapGeoJSONRenderer(mapChart) {
    _classCallCheck(this, MapGeoJSONRenderer);
    ...
    function mouseClick(event, feature) {
      ...
      if (mapChart.config.sendsNotifications) {
        var locationID = feature.lotivisId;
    ...
    this.render = function () {
      var geoJSON = mapChart.presentedGeoJSON;
      if (!geoJSON) return;
      mapChart.areas = mapChart.svg.selectAll("path").data(geoJSON.features).enter().append("path").attr("d", mapChart.path).attr("id", function (feature) {
        return "ltv-map-chart-area-id-".concat(feature.lotivisId);
      }).classed("ltv-map-chart-area", true).style("stroke-dasharray", function (feature) {
        return feature.departmentsData ? "0" : "1,4";
      }).style("fill", "white").style("fill-opacity", 1).on("click", mouseClick).on("mouseenter", mouseEnter).on("mouseout", mouseOut);
    };
  });
  ...
  function joinFeatures(features) {
    var topology$1 = topology(features);
    var objects = extractObjects(topology$1);
    return {
      type: "FeatureCollection",
      features: [{
        type: "Feature",
  ...
  function extractObjects(topology) {
    ...
    for (var topologyKey in topology.objects) {
  ...
  var MapExteriorBorderRenderer = /*#__PURE__*/_createClass(
  /**
   * Creates a new instance of MapExteriorBorderRenderer.
   * @property mapChart The parental map.chart chart.
   */
  function MapExteriorBorderRenderer(mapChart) {
    _classCallCheck(this, MapExteriorBorderRenderer);
    ...
    this.render = function () {
      if (!topojson) {
        exports.lotivis_log("[lotivis]  Can't find topojson library.");
        return;
      }
      ...
      if (!geoJSON) {
        exports.lotivis_log("[lotivis]  No GeoJSON to render.");
        return;
      }

      var borders = joinFeatures(geoJSON.features);

      if (!borders) {
        return exports.lotivis_log("[lotivis]  No borders to render.");
      }
  ...
  function flatDatasets(datasets) {
    ...
    for (var datasetIndex = 0; datasetIndex < datasetsCopy.length; datasetIndex++) {
      var dataset = datasetsCopy[datasetIndex];
      var flatDataChunk = flatDataset(dataset);
  ...
  function flatDataset(dataset) {
    ...
    if (!dataset.data) {
      exports.lotivis_log("[lotivis]  INFO Flat samples for dataset without samples requested. Will return an empty array.", dataset);
      return flatData;
    }
  ...
  function extractLabelsFromDatasets(datasets) {
    return toSet(datasets.map(function (dataset) {
      return toValue(dataset.label);
    }));
  }
  /**
  ...
  function extractStacksFromDatasets(datasets) {
    return toSet(datasets.map(function (dataset) {
      return toValue(dataset.stack || dataset.label);
    }));
  }
  /**
  ...
  function extractDatesFromFlatData(flatData) {
    return toSet(flatData.map(function (item) {
      return toValue(item.date);
    }));
  }
  /**
   * Returns the set of locations from the given dataset collection.
  ...
  function extractEarliestDate(flatData) {
    var dateAccess = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : function (date) {
      return date;
    };
    return extractDatesFromFlatData(flatData).sort(function (left, right) {
  ...
  function createGeoJSON(datasets) {
    var locations = extractLocationsFromDatasets(datasets);
    var rowsCount = Math.ceil(locations.length / 5);
    var latSpan = 0.1;
    var lngSpan = 0.1;
    var features = [];

    loop1: for (var rowIndex = 0; rowIndex < rowsCount; rowIndex++) {
      for (var itemIndex = 0; itemIndex < 5; itemIndex++) {
        if (locations.length === 0) break loop1;
        var location = locations.shift();
        var lat = (itemIndex + 1) * latSpan;
        var lng = (rowIndex + 1) * -lngSpan; // start down left, counterclockwise
  ...
  var MapChartConfig = {
    ...
    sendsNotifications: true,
    featureIDAccessor: function featureIDAccessor(feature) {
    ...
    featureNameAccessor: function featureNameAccessor(feature) {
   ...
   */
  var MapBackgroundRenderer = /*#__PURE__*/_createClass(
  /**
   * Creates a new instance of MapBackgroundRenderer.
   *
   * @param mapChart The parental map.chart chart.
   */
  function MapBackgroundRenderer(mapChart) {
    _classCallCheck(this, MapBackgroundRenderer);

    function onMouseClick() {
      var controller = mapChart.datasetController;
      if (!controller) return;
      var filters = controller.filters.locations;
   ...
   * @class Geometry
   */
  var Geometry = /*#__PURE__*/_createClass(
  /**
  ...
  var Feature = /*#__PURE__*/_createClass(function Feature(source) {
  ...
  var GeoJson = /*#__PURE__*/function () {
    function GeoJson(source) {
      ...
      if (source.features) {
        for (var index = 0; index < source.features.length; index++) {
          var featureSource = source.features[index];
          var feature = new Feature(featureSource);
    ...
    _createClass(GeoJson, [{
      ...
      value: function getCenter() {
        var allCoordinates = this.extractAllCoordinates();
      ...
      key: "extractGeometryCollection",
      value: function extractGeometryCollection() {
        ...
        if (this.type === 'Feature') {
          ...
          this.features.forEach(function (feature) {
            return geometryCollection.push(feature.geometry);
          });
        } else if (this.type === 'GeometryCollection') {
          this.geometries.forEach(function (geometry) {
            return geometryCollection.push(geometry);
          });
        } else {
      ...
      key: "extractAllCoordinates",
      value: function extractAllCoordinates() {
        var geometryCollection = this.extractGeometryCollection();
        var coordinatesCollection = [];
        geometryCollection.forEach(function (item) {
          ...
          if (type === 'Point') {
            ...
            coordinates.forEach(function (coordinate) {
              return coordinatesCollection.push(coordinate);
            });
  ...
  var MapSelectionRenderer = /*#__PURE__*/_createClass(
  /**
   * Creates a new instance of MapSelectionRenderer.
   *
   * @param mapChart The parental map.chart chart.
   */
  function MapSelectionRenderer(mapChart) {
    _classCallCheck(this, MapSelectionRenderer);
    ...
    function getSelectedFeatures() {
      ...
      var allFeatures = mapChart.presentedGeoJSON.features;

      if (!mapChart.datasetController) {
        return null;
      }

      var filteredLocations = mapChart.datasetController.filters.locations;
      var selectedFeatures = [];

      for (var index = 0; index < allFeatures.length; index++) {
        var feature = allFeatures[index];
        var featureID = feature.lotivisId;
    ...
    this.render = function () {
      ...
      if (!mapChart.selectionBorderGeoJSON) {
        return exports.lotivis_log("[lotivis]  No selected features to render.");
      }
  ...
  var MapChart = /*#__PURE__*/function (_Chart) {
     ...
     */
    function MapChart(parent, config) {
      _classCallCheck(this, MapChart);

      return _super.call(this, parent, config); // empty. constructor defined for documentation.
    }
    /**
    ...
    _createClass(MapChart, [{
      ...
      value: function initialize() {
        ...
        var config = Object.assign({}, MapChartConfig);
        this.config = Object.assign(config, this.config);
        this.config.margin = margin;
      ...
      value: function precalculate() {
        ...
        var geoJSON = createGeoJSON(this.datasetController.datasets);
        this.setGeoJSON(geoJSON);
      }
    }, {
      key: "draw",
      value: function draw() {
        exports.lotivis_log("[lotivis] ", this.constructor.name, "draw");

        if (!this.geoJSON) {
          return exports.lotivis_log("[lotivis]  No GeoJSON to render.");
        }
      ...
      key: "renderSVG",
      value: function renderSVG() {
        this.svg = this.element.append("svg").classed("ltv-chart-svg ltv-map-chart-svg", true).attr("id", this.svgSelector).attr("viewBox", "0 0 ".concat(this.config.width, " ").concat(this.config.height));
      }
      /**
      ...
      key: "onSelectFeature",
      value: function onSelectFeature(event, feature) {}
      /**
      ...
      key: "setGeoJSON",
      value: function setGeoJSON(newGeoJSON) {
        if (_typeof(newGeoJSON) === "object" && newGeoJSON.prototype === "GeoJSON") {
      ...
      value: function geoJSONDidChange() {
        ...
        for (var i = 0; i < this.presentedGeoJSON.features.length; i++) {
  ...
  var MapChartSettingsPopup = /*#__PURE__*/function (_SettingsPopup) {
    _inherits(MapChartSettingsPopup, _SettingsPopup);

    var _super = _createSuper(MapChartSettingsPopup);

    function MapChartSettingsPopup() {
      _classCallCheck(this, MapChartSettingsPopup);

      return _super.apply(this, arguments);
    }

    _createClass(MapChartSettingsPopup, [{
      key: "inject",
      value:
      /**
       ...
       */
      function inject() {
        _get(_getPrototypeOf(MapChartSettingsPopup.prototype), "inject", this).call(this);

        var container = this.row.append("div").classed("col-12", true);
        this.showLabelsCheckbox = new Checkbox(container);
        this.showLabelsCheckbox.setText("Labels");
  ...
  var MapChartCard = /*#__PURE__*/function (_ChartCard) {
    _inherits(MapChartCard, _ChartCard);

    var _super = _createSuper(MapChartCard);
     ...
     */
    function MapChartCard(parent, config) {
      _classCallCheck(this, MapChartCard);

      return _super.call(this, parent || "map-chart-card", config);
    }
    /**
    ...
    _createClass(MapChartCard, [{
      ...
      value: function screenshotButtonAction() {
        ...
        var downloadFilename = createDownloadFilename(filename, "map-chart");
        downloadImage(this.chart.svgSelector, downloadFilename);
      }
      /**
       * Triggered when the more button is pushed.
      ...
      value: function presentSettingsPopupAction() {
        ...
        var button = document.getElementById(this.moreButton.selector);
        var settingsPopup = new MapChartSettingsPopup(bodyElement);
  ...
  var DefaultDateAccess = function DefaultDateAccess(date) {
    return date;
  };
  /**
   *
  ...
  var FormattedDateAccess = function FormattedDateAccess(dateString) {
    var value = Date.parse(dateString);

    if (isNaN(value)) {
      lotivis_log_once("Received NaN for date \"".concat(dateString, "\""));
    }
  ...
  var DateGermanAssessor = function DateGermanAssessor(dateString) {
    var saveDateString = String(dateString);
    var components = saveDateString.split(".");
  ...
  var DateWeekAssessor = function DateWeekAssessor(weekday) {
    var lowercase = weekday.toLowerCase();
   ...
   * @class DataViewCache
   */
  var DataViewCache = /*#__PURE__*/_createClass(
  /**
   * Creates a new instance of DataViewCache.
   */
  function DataViewCache() {
    _classCallCheck(this, DataViewCache);
    ...
    this.getDataView = function (type, locationFilters, dateFilters, datasetFilters) {
      var name = createName(type, locationFilters, dateFilters, datasetFilters);
      return content[name];
    };
    /**
  ...
  var DatasetsController = /*#__PURE__*/function () {
    /**
     * Creates a new instance of DatasetsController
     * @param datasets The datasets to control.
     * @param config
     */
    function DatasetsController(datasets, config) {
      _classCallCheck(this, DatasetsController);
    ...
    _createClass(DatasetsController, [{
      key: "initialize",
      ...
      key: "getFlatDataCombinedStacks",
      value: function getFlatDataCombinedStacks() {
        return combineByStacks(this.flatData);
      }
    }, {
      key: "getFlatDataCombinedDates",
      value: function getFlatDataCombinedDates() {
        return combineByDate(this.flatData);
      }
    }, {
      key: "getFlatDataCombinedLocations",
      value: function getFlatDataCombinedLocations() {
        return combineByLocation(this.flatData);
      }
    }, {
      key: "getSumOfLabel",
      value: function getSumOfLabel(label) {
        return sumOfLabel(this.flatData, label);
      }
    }, {
      key: "getSumOfDataset",
      value: function getSumOfDataset(dataset) {
        return sumOfDataset(this.flatData, dataset);
      }
    }, {
      key: "getSumOfStack",
      value: function getSumOfStack(stack) {
      ...
      key: "getColorForDataset",
      value: function getColorForDataset(label) {
        return this.datasetsColorsController.colorForDataset(label);
      }
    }, {
      key: "getColorForStack",
      value: function getColorForStack(stack) {
        return this.datasetsColorsController.colorForStack(stack);
      }
    }, {
      key: "getColorsForStack",
      value: function getColorsForStack(stack) {
  ...
  function createPlotDataset(dataset, dateAccess) {
    var newDataset = {};
    var data = copy(dataset.data);
    var firstDate = extractEarliestDateWithValue(data, dateAccess) || 0;
    var lastDate = extractLatestDateWithValue(data, dateAccess) || 0;
    var flatData = flatDataset(dataset);
    ...
    newDataset.data = combineByDate(data).sort(function (left, right) {
      return left.dateNumeric - right.dateNumeric;
  ...
  DatasetsController.prototype.getPlotDataview = function () {
    var cachedDataView = this.getCached("plot");

    if (cachedDataView) {
      return cachedDataView;
    }

    var dateAccess = this.dateAccess;
    var enabledDatasets = this.filteredDatasets();
    var dataview = {
      datasets: []
    };
    ...
    enabledDatasets.forEach(function (dataset) {
      var newDataset = createPlotDataset(dataset, dateAccess);
      var firstIndex = dataview.dates.indexOf(newDataset.firstDate);
      var lastIndex = dataview.dates.indexOf(newDataset.lastDate);
      newDataset.duration = lastIndex - firstIndex;
      dataview.datasets.push(newDataset);
    });
    dataview.labelsCount = dataview.datasets.length;
    dataview.max = max$3(dataview.datasets, function (dataset) {
      return max$3(dataset.data, function (item) {
        return item.value;
      });
    });
  ...
  var PlotAxisRenderer = /*#__PURE__*/_createClass(
  /**
   * Creates a new instance of PlotAxisRenderer.
   * @constructor
   * @param plotChart The parental date.chart.plot.chart chart.
   */
  function PlotAxisRenderer(plotChart) {
    _classCallCheck(this, PlotAxisRenderer);

    /**
     * Appends axis on the top, left and bottom of the date.chart.plot.chart chart.
     */
    this.renderAxis = function () {
      var margin = plotChart.config.margin; // top

      plotChart.svg.append("g").call(axisTop(plotChart.xChart)).attr("transform", function () {
        return "translate(0,".concat(margin.top, ")");
      }); // left

      plotChart.svg.append("g").call(axisLeft(plotChart.yChart)).attr("transform", function () {
        return "translate(".concat(margin.left, ",0)");
      }); // bottom

      plotChart.svg.append("g").call(axisBottom(plotChart.xChart)).attr("transform", function () {
        return "translate(0,".concat(plotChart.height - margin.bottom, ")");
      });
    };
  });
  ...
  var PlotTooltipRenderer = /*#__PURE__*/_createClass(
  /**
   ...
   * @param plotChart
   */
  function PlotTooltipRenderer(plotChart) {
    _classCallCheck(this, PlotTooltipRenderer);

    var tooltip = plotChart.element.append("div").attr("class", "ltv-tooltip").attr("rx", 5) // corner radius
    .attr("ry", 5).style("opacity", 0);
    /**
    ...
    function getHTMLContentForDataset(dataset) {
      ...
      var components = [];
      var sum = dataset.data.map(function (item) {
        return item.value;
      }).reduce(function (acc, next) {
        return +acc + +next;
      }, 0);
      var formatted = plotChart.config.numberFormat.format(sum);
      ...
      components.push("");
      var filtered = dataset.data.filter(function (item) {
        return item.value !== 0;
      });
      ...
      for (var index = 0; index < filtered.length; index++) {
        ...
        var _formatted = plotChart.config.numberFormat.format(entry.value);

        components.push("".concat(entry.date, ": ").concat(_formatted));
      }
    ...
    function getTooltipLeftForDataset(dataset, factor, offset) {
      var left = plotChart.xChart(dataset.firstDate);
      left *= factor;
      left += offset[0];
      return left;
    }
    ...
    this.showTooltip = function (event, dataset) {
      ...
      var tooltipHeight = Number(tooltip.style("height").replace("px", ""));
      var factor = plotChart.getElementEffectiveSize()[0] / plotChart.config.width;
      var offset = plotChart.getElementPosition();
      var top = plotChart.yChart(dataset.label) * factor;
      top += offset[1];
      ...
      var left = getTooltipLeftForDataset(dataset, factor, offset);
    ...
    this.hideTooltip = function () {
      var controller = plotChart.datasetController;
      var filters = controller.datasetFilters;
  ...
  var PlotLabelRenderer = /*#__PURE__*/_createClass(
  /**
   ...
   * @param plotChart The parental date.chart.plot.chart chart.
   */
  function PlotLabelRenderer(plotChart) {
    _classCallCheck(this, PlotLabelRenderer);
    ...
    this.renderLabels = function () {
      ...
      var xBandwidth = plotChart.yChart.bandwidth();
      var xChart = plotChart.xChart;
      plotChart.labels = plotChart.barsData.append("g").attr("transform", "translate(0,".concat(xBandwidth / 2 + 4, ")")).append("text").attr("class", "ltv-plot-label").attr("id", function (d) {
        return "rect-" + hashCode(d.label);
      }).attr("x", function (d) {
        return xChart(d.firstDate) + xBandwidth / 2;
      }).attr("y", function (d) {
        return plotChart.yChart(d.label);
      }).attr("width", function (d) {
        return xChart(d.lastDate) - xChart(d.firstDate) + xBandwidth;
      }).text(function (dataset) {
        if (dataset.sum === 0) return;
        var formatted = plotChart.config.numberFormat.format(dataset.sum);
        return "".concat(dataset.duration + 1, " years, ").concat(formatted, " items");
      });
    };
  });
   ...
   */
  var PlotGridRenderer = /*#__PURE__*/_createClass(
  /**
   ...
   * @param plotChart The parental date.chart.plot.chart chart.
   */
  function PlotGridRenderer(plotChart) {
    _classCallCheck(this, PlotGridRenderer);
    ...
    this.render = function () {
      ...
      plotChart.svg.append("g").attr("class", "ltv-plot-grid ltv-plot-grid-y").attr("transform", "translate(".concat(plotChart.config.margin.left, ",0)")).call(plotChart.yAxisGrid);
    };
  });
   ...
   */
  var PlotBackgroundRenderer = /*#__PURE__*/_createClass(
  /**
   *
   * @param plotChart
   */
  function PlotBackgroundRenderer(plotChart) {
    _classCallCheck(this, PlotBackgroundRenderer);

    this.render = function () {
      plotChart.svg.append("rect").attr("width", plotChart.width || plotChart.config.width).attr("height", plotChart.height).attr("class", "ltv-plot-chart-background").on("click", function (event, some) {
  ...
  var PlotChartHoverBarsRenderer = /*#__PURE__*/_createClass(
  /**
   * Creates a new instance of PlotAxisRenderer.
   * @constructor
   * @param plotChart The parental date.chart.plot.chart chart.
   */
  function PlotChartHoverBarsRenderer(plotChart) {
    _classCallCheck(this, PlotChartHoverBarsRenderer);

    function createID(dataset) {
      return "ltv-plot-chart-hover-bar-id-".concat(createIDFromDataset(dataset));
    }
    ...
    function mouseEnter(event, dataset) {
      hideAll();
      var id = createID(dataset);
      plotChart.svg.select("#".concat(id)).attr("opacity", 0.3);
    ...
    this.render = function () {
      var datasets = plotChart.dataView.datasets;
      var graphWidth = plotChart.graphWidth;
      plotChart.backgrounBarsData = plotChart.svg.append("g").selectAll("g").data(datasets).enter();
      plotChart.backgrounBars = plotChart.backgrounBarsData.append("rect").attr("id", function (d) {
        return createID(d);
      }).attr("class", "ltv-plot-chart-hover-bar").attr("opacity", 0).attr("x", plotChart.config.margin.left).attr("y", function (d) {
        return plotChart.yChart(d.label);
      }).attr("height", plotChart.yChart.bandwidth()).attr("width", graphWidth).on("mouseenter", mouseEnter).on("mouseout", mouseOut).on("click", mouseClick);
    };
  });
  ...
  var PlotBarsFractionsRenderer = /*#__PURE__*/_createClass(
  /**
   * Creates a new instance of PlotAxisRenderer.
   * @constructor
   * @param plotChart The parental date.chart.plot.chart chart.
   */
  function PlotBarsFractionsRenderer(plotChart) {
    _classCallCheck(this, PlotBarsFractionsRenderer);
    ...
    this.renderBars = function () {
      var datasets = plotChart.dataView.datasets;
      var max = plotChart.dataView.max;
      var flatData = flatDatasets(datasets);
      flatData = combineByDate(flatData);
      plotChart.barsData = plotChart.svg.append("g").selectAll("g").data(flatData).enter();
      var colors = Color$1.mapColors(max);
      plotChart.bars = plotChart.barsData.append("rect").attr("id", function (d) {
        return "ltv-plot-bar-".concat(createIDFromDataset(d));
      }).attr("class", "ltv-plot-bar").attr("fill", function (d) {
        return colors(d.value);
      }).attr("rx", radius).attr("ry", radius).attr("x", function (d) {
        return plotChart.xChart(d.date);
      }).attr("y", function (d) {
        return plotChart.yChartPadding(d.label);
      }).attr("height", plotChart.yChartPadding.bandwidth()).attr("id", function (d) {
        return "rect-" + createIDFromDataset(d);
      }).on("mouseenter", mouseEnter).on("mouseout", mouseOut).attr("width", plotChart.xChart.bandwidth());
    };
  });
  ...
  var PlotBarsGradientCreator = /*#__PURE__*/function () {
    /**
     ...
     * @param plotChart The parental date.chart.plot.chart chart.
     */
    function PlotBarsGradientCreator(plotChart) {
      _classCallCheck(this, PlotBarsGradientCreator);
    ...
    _createClass(PlotBarsGradientCreator, [{
      key: "createGradient",
      value: function createGradient(dataset) {
        var max = this.plotChart.dataView.max;
        var gradient = this.plotChart.definitions.append("linearGradient").attr("id", "ltv-plot-gradient-" + createIDFromDataset(dataset)).attr("x1", "0%").attr("x2", "100%").attr("y1", "0%").attr("y2", "0%");
        var data = dataset.data;
        var count = data.length;
        var latestDate = dataset.lastDate;
        ...
        if (duration === 0) {
          ...
          for (var index = 0; index < count; index++) {
            ...
            var _opacity = _item.value / max;

            var dateDifference = latestDate - date;

            var _value = dateDifference / duration;

            var datePercentage = (1 - _value) * 100;
            gradient.append("stop").attr("offset", "".concat(datePercentage, "%")).attr("stop-color", this.colorGenerator(_opacity));
          }
        }
      }
    }]);

    return PlotBarsGradientCreator;
  }();
  ...
  var PlotBarsGradientRenderer = /*#__PURE__*/_createClass(
  /**
   * Creates a new instance of PlotAxisRenderer.
   * @constructor
   * @param plotChart The parental date.chart.plot.chart chart.
   */
  function PlotBarsGradientRenderer(plotChart) {
    _classCallCheck(this, PlotBarsGradientRenderer);
    ...
    this.renderBars = function () {
      ...
      plotChart.bars = plotChart.barsData.append("rect").attr("fill", function (d) {
        return "url(#ltv-plot-gradient-".concat(createIDFromDataset(d), ")");
      }).attr("class", "ltv-plot-bar").attr("rx", radius).attr("ry", radius).attr("x", function (d) {
        return plotChart.xChart(d.duration < 0 ? d.lastDate : d.firstDate || 0);
      }).attr("y", function (d) {
        return plotChart.yChartPadding(d.label);
      }).attr("height", plotChart.yChartPadding.bandwidth()).attr("id", function (d) {
        return "ltv-plot-rect-" + createIDFromDataset(d);
  ...
  var PlotLabelsFractionsRenderer = /*#__PURE__*/_createClass(
  /**
   * Creates a new instance of PlotLabelRenderer.
   *
   * @constructor
   * @param plotChart The parental date.chart.plot.chart chart.
   */
  function PlotLabelsFractionsRenderer(plotChart) {
    _classCallCheck(this, PlotLabelsFractionsRenderer);
    ...
    this.renderLabels = function () {
      ...
      plotChart.labels = plotChart.barsData.append("g").attr("transform", "translate(0,".concat(xBandwidth / 2 + 4, ")")).append("text").attr("class", "ltv-plot-label").attr("id", function (d) {
        ...
        return plotChart.xChart(d.date) + 4;
      }).attr("y", function (d) {
        return plotChart.yChart(d.label);
      }).text(function (dataset) {
        if (dataset.sum === 0) return;
        var formatted = plotChart.config.numberFormat.format(dataset.value);
  ...
  var PlotChartSelectionRenderer = /*#__PURE__*/_createClass(
  /**
   ...
   */
  function PlotChartSelectionRenderer(plotChart) {
    _classCallCheck(this, PlotChartSelectionRenderer);

    function createID(dataset) {
      return "ltv-plot-chart-selection-rect-id-".concat(createIDFromDataset(dataset));
    }
    /**
     * Draws the bars.
     */
    ...
    this.render = function () {
      ...
      plotChart.selectionBars = plotChart.selectionBarsData.append("rect").attr("id", function (d) {
        return createID(d);
      }).attr("class", "ltv-plot-chart-selection-rect").attr("opacity", 0).attr("x", plotChart.config.margin.left).attr("y", function (d) {
        return plotChart.yChart(d.label);
      }).attr("height", plotChart.yChart.bandwidth()).attr("width", graphWidth);
    };

    this.update = function () {
      var selectedLabels = getSelectedLabels();
      plotChart.svg.selectAll(".ltv-plot-chart-selection-rect").attr("opacity", function (dataset) {
        return selectedLabels.includes(dataset.label) ? 0.3 : 0;
      });
  ...
  var PlotChart = /*#__PURE__*/function (_Chart) {
    _inherits(PlotChart, _Chart);

    var _super = _createSuper(PlotChart);
    ...
    _createClass(PlotChart, [{
      ...
      function initialize() {
        ...
        margin = Object.assign(margin, this.config.margin);
        var config = Object.assign({}, defaultPlotChartConfig);
        this.config = Object.assign(config, this.config);
        this.config.margin = margin;
        this.createSVG();
      ...
      value: function createSVG() {
        this.svg = this.element.append("svg").attr("id", this.svgSelector).attr("class", "ltv-chart-svg ltv-plot-chart-svg").attr("preserveAspectRatio", "xMidYMid meet").attr("viewBox", "0 0 ".concat(this.config.width, " ").concat(this.config.height));
      }
      /**
      ...
      value: function precalculate() {
        ...
        var barsCount = this.dataView.labelsCount || 0;
        ...
        this.svg.attr("viewBox", "0 0 ".concat(this.config.width, " ").concat(this.preferredHeight));
        this.createScales();
      }
      /**
       * Creates and renders the chart.
      ...
      key: "update",
      value: function update(controller, reason) {
        if (!this.updateSensible) return;
      ...
      key: "createScales",
      value: function createScales() {
        this.xChart = band().domain(this.dataView.dates || []).rangeRound([this.config.margin.left, this.config.width - this.config.margin.right]).paddingInner(0.1);
        this.yChartPadding = band().domain(this.dataView.labels || []).rangeRound([this.height - this.config.margin.bottom, this.config.margin.top]).paddingInner(0.1);
        this.yChart = band().domain(this.dataView.labels || []).rangeRound([this.height - this.config.margin.bottom, this.config.margin.top]);
        this.xAxisGrid = axisBottom(this.xChart).tickSize(-this.graphHeight).tickFormat("");
        this.yAxisGrid = axisLeft(this.yChart).tickSize(-this.graphWidth).tickFormat("");
      }
      /**
       *
       * @param event
      ...
      key: "onSelectDataset",
      value: function onSelectDataset(event, dataset) {
      ...
      key: "sortDatasets",
      value: function sortDatasets() {
        var datasets = this.dataView.datasets;
        var sortedDatasets = [];

        switch (this.config.sort) {
          case PlotChartSort.alphabetically:
            sortedDatasets = datasets.sort(function (set1, set2) {
              return set1.label > set2.label;
            });
            break;

          case PlotChartSort.duration:
            sortedDatasets = datasets.sort(function (set1, set2) {
              return set1.duration < set2.duration;
            });
            break;

          case PlotChartSort.intensity:
            sortedDatasets = datasets.sort(function (set1, set2) {
              return set1.sum < set2.sum;
            });
            break;

          case PlotChartSort.firstDate:
            sortedDatasets = datasets.sort(function (set1, set2) {
              return set1.firstDate > set2.firstDate;
            });
            break;
        ...
        this.dataView.labels = sortedDatasets.map(function (dataset) {
  ...
  var PlotChartCardSettingsPopup = /*#__PURE__*/function (_SettingsPopup) {
    _inherits(PlotChartCardSettingsPopup, _SettingsPopup);

    var _super = _createSuper(PlotChartCardSettingsPopup);

    function PlotChartCardSettingsPopup() {
      _classCallCheck(this, PlotChartCardSettingsPopup);

      return _super.apply(this, arguments);
    }

    _createClass(PlotChartCardSettingsPopup, [{
      key: "inject",
      value:
      /**
       ...
       */
      function inject() {
        _get(_getPrototypeOf(PlotChartCardSettingsPopup.prototype), "inject", this).call(this);

        var container = this.row.append('div');
        var showLabelsCheckboxContainer = container.append('div').classed('lotivis-settings-card-row', true);
        ...
        var typeDropdownContainer = container.append('div').classed('lotivis-settings-card-row', true);
        ...
        var dropdownContainer = container.append('div').classed('lotivis-settings-card-row', true);
    ...
    return PlotChartCardSettingsPopup;
  }(SettingsPopup);
  ...
  var PlotChartCard = /*#__PURE__*/function (_ChartCard) {
    _inherits(PlotChartCard, _ChartCard);

    var _super = _createSuper(PlotChartCard);
     ...
     * @param config
     */
    function PlotChartCard(selector, config) {
      var _this;

      _classCallCheck(this, PlotChartCard);

      var theSelector = selector || "plot-chart-card";
      _this = _super.call(this, theSelector, config);

      _this.applyURLParameters(); // this.setTitle('Plot');
    ...
    _createClass(PlotChartCard, [{
      ...
      key: "applyURLParameters",
      value: function applyURLParameters() {
        var instance = UrlParameters.getInstance();
      ...
      value: function presentSettingsPopupAction() {
        var bodyElement = select("body");
        var button = document.getElementById(this.moreButton.selector);
        var settingsPopup = new PlotChartCardSettingsPopup(bodyElement);
        settingsPopup.chart = this.chart;
        settingsPopup.showUnder(button, "right");
      }
      /**
      ...
      key: "screenshotButtonAction",
      value: function screenshotButtonAction() {
        var filename = this.chart.datasetController.getFilename();
        var downloadFilename = createDownloadFilename(filename, "plot-chart");
        downloadImage(this.chart.svgSelector, downloadFilename);
      }
    }]);

    return PlotChartCard;
  }(ChartCard);
  ...
  var TextareaCard = /*#__PURE__*/function (_Card) {
    _inherits(TextareaCard, _Card);

    var _super = _createSuper(TextareaCard);

    /**
     * Creates a new instance of TextareaCard.
     * @param parent The parental element or a selector (id).
     */
    function TextareaCard(parent) {
      var _this;

      _classCallCheck(this, TextareaCard);
      ...
      if (_this.config) {
        _this.textarea.attr('rows', _this.config.lines || 25);

        _this.setTitle(_this.config.title || _this.getClassname());
      } else {
        _this.textarea.attr('rows', 25);

        _this.setTitle(_this.getClassname());
      }
    ...
    _createClass(TextareaCard, [{
      ...
      key: "getTextareaContent",
      value: function getTextareaContent() {
      ...
      key: "enableTextarea",
      value: function enableTextarea() {
        this.textarea.attr('disabled', null);
        [this.textarea, this.titleLabel].forEach(function (item) {
          return item.classed('lotivis-disabled', false);
        });
      }
      /**
      ...
      key: "disableTextarea",
      value: function disableTextarea() {
        this.textarea.attr('disabled', '');
        [this.textarea, this.titleLabel].forEach(function (item) {
          return item.classed('lotivis-disabled', true);
        });
      }
      /**
  ...
  var UpdatableDataviewCard = /*#__PURE__*/function (_TextareaCard) {
    _inherits(UpdatableDataviewCard, _TextareaCard);

    var _super = _createSuper(UpdatableDataviewCard);

    /**
     * Creates a new instance of UpdatableDataviewCard.
     * @param parent The parental element or a selector (id).
     */
    function UpdatableDataviewCard() {
      var _this;

      var parent = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};

      _classCallCheck(this, UpdatableDataviewCard);

      // parent.title = parent.title || 'UpdatableDataviewCard';
      _this = _super.call(this, parent);
      _this.updateSensible = true;

      _this.downloadButton.hide();
    ...
    _createClass(UpdatableDataviewCard, [{
      key: "setDatasetsController",
      value: function setDatasetsController(newDatasetsController) {
      ...
      value: function update(datasetsController, reason) {
        if (!this.updateSensible) {
          exports.lotivis_log("[lotivis]  NOT sensible ".concat(this, ". Reason '").concat(reason, "'."));
          return;
        } else if (this.config && this.config.updateSensible === false) {
          exports.lotivis_log("[lotivis]  NOT sensible (Config) ".concat(this, ". Reason '").concat(reason, "'."));
          return;
        } else if (!datasetsController) {
          exports.lotivis_log("[lotivis]  NO controller ".concat(this, ". Reason '").concat(reason, "'."));
          return;
        }

        var datasets = datasetsController.datasets;
        var content = this.datasetsToText(datasetsController, datasets);
        this.setTextareaContent(content);
        this.cachedDatasets = datasets;
        exports.lotivis_log("[lotivis]  Update ".concat(this, ". Reason '").concat(reason, "'."));
      }
      /**
      ...
      key: "datasetsToText",
      value: function datasetsToText(controller, datasets) {
        throw new LotivisUnimplementedMethodError("Subclasses should override.");
      }
    }]);

    return UpdatableDataviewCard;
  }(TextareaCard);
  ...
  var Toast = /*#__PURE__*/function (_Component) {
    ...
    function Toast(parent) {
      ...
      _this = _super.call(this, parent);
      _this.element = _this.parent.append("div").attr("class", "lotivis-data-card-status-tooltip").style("opacity", 0).style("display", "none");
      _this.row = _this.element.append("div").attr("class", "row");
      _this.leftComponnt = _this.row.append("div").attr("class", "col-6");
      _this.rightComponent = _this.row.append("div").attr("class", "col-6");
      _this.hideButton = new Button(_this.rightComponent).setText("Hello");
      return _this;
    }
    /**
     * Shows the toast.
    ...
    _createClass(Toast, [{
      ...
      key: "hide",
      value: function hide() {
        _get(_getPrototypeOf(Toast.prototype), "hide", this).call(this);
      ...
      value: function setStatusMessage(newStatusMessage) {
        var saveString = String(newStatusMessage || "").trim();
  ...
  function validateDataset(dataset) {
    if (!dataset) {
      ...
      throw new MissingPropertyError("Missing label for dataset. ".concat(dataset));
    } else if (!dataset.data) {
      throw new MissingPropertyError("Invalid data. Property is not an array. Dataset: ".concat(dataset.label));
    } else if (!Array.isArray(dataset.data)) {
      throw new InvalidFormatError("Invalid data. Property is not an array. Dataset: ".concat(dataset.label));
    }
  ...
  var EditableDataviewCard = /*#__PURE__*/function (_UpdatableDataviewCar) {
    _inherits(EditableDataviewCard, _UpdatableDataviewCar);

    var _super = _createSuper(EditableDataviewCard);

    /**
     * Creates a new instance of DatasetCard.
     * @param parent The parental element or a selector (id).
     */
    function EditableDataviewCard(parent) {
      var _this;

      _classCallCheck(this, EditableDataviewCard);

      _this = _super.call(this, parent);
      _this.toast = new Toast(_this.parent);

      _this.downloadButton.show();
    ...
    _createClass(EditableDataviewCard, [{
      key: "onKeyup",
      ...
      key: "updateDatasetsOfController",
      value: function updateDatasetsOfController() {
        var notifyController = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : false;
        var content = this.getTextareaContent();
        this.toast.setStatusMessage(null);

        try {
          // will throw an error if parsing is not possible
          var parsedDatasets = this.textToDatasets(content);
          ...
          if (notifyController === true) {
            if (!this.datasetsController) {
              return exports.lotivis_log("[lotivis]  No datasets controller.");
            }

            if (objectsEqual(this.cachedDatasets, parsedDatasets)) {
              return exports.lotivis_log("[lotivis]  No changes in datasets.");
            }
          ...
          exports.lotivis_log("[lotivis]  ERROR: ".concat(error));
          this.toast.setStatusMessage(error);
        }
      }
    }, {
      key: "datasetsToText",
      value: function datasetsToText(datasets) {
        return new LotivisUnimplementedMethodError('datasetsToText(datasets)');
      }
    }]);

    return EditableDataviewCard;
  ...
  var DatasetsJSONCard = /*#__PURE__*/function (_EditableDataviewCard) {
    _inherits(DatasetsJSONCard, _EditableDataviewCard);

    var _super = _createSuper(DatasetsJSONCard);

    /**
     * Creates a new instance of DatasetJSONCard.
     * @param parent The parental element or a selector (id).
     */
    function DatasetsJSONCard() {
      var _this;

      var parent = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'datasets-json-card';

      _classCallCheck(this, DatasetsJSONCard);
      ...
      _this.setTitle('Dataset JSON');

      return _this;
    }

    _createClass(DatasetsJSONCard, [{
      key: "download",
      value: function download(content) {
        var filename = this.datasetsController.getFilename();
        var downloadFilename = createDownloadFilename(filename, "datasets");
        downloadJSON(content, downloadFilename);
      }
    }, {
      key: "textToDatasets",
      value: function textToDatasets(text) {
        if (text === "") return [];
        return JSON.parse(text.trim());
      }
    }, {
      key: "datasetsToText",
      value: function datasetsToText(datasetsController) {
        return JSON.stringify(datasetsController.datasets, null, 2) || "";
      }
    }]);

    return DatasetsJSONCard;
   ...
   */
  var csvStringToArray = function csvStringToArray(strData) {
  ...
  function trimByChar(string, character) {
    var saveString = String(string);

    var first = _toConsumableArray(saveString).findIndex(function (_char) {
      return _char !== character;
    });

    var last = _toConsumableArray(saveString).reverse().findIndex(function (_char2) {
      return _char2 !== character;
    });
  ...
  function createDatasets(flatData) {
    ...
    for (var itemIndex = 0; itemIndex < flatData.length; itemIndex++) {
      var item = flatData[itemIndex];
      var label = item.dataset || item.label;
      var dataset = datasetsByLabel[label];
    ...
    var datasets = [];
    var labels = Object.getOwnPropertyNames(datasetsByLabel);

    for (var index = 0; index < labels.length; index++) {
      var _label = labels[index];
      if (_label.length === 0) continue;
      datasets.push(datasetsByLabel[_label]);
    }
  ...
  function parseCSV(text) {
    var flatData = [];
    var arrays = csvStringToArray(text);
    var headlines = arrays.shift();

    for (var lineIndex = 0; lineIndex < arrays.length; lineIndex++) {
      var lineArray = arrays[lineIndex].map(function (element) {
        return trimByChar(element, "\"");
      });

      if (lineArray.length < 5) {
        exports.lotivis_log("Skipping row: ".concat(lineArray));
        continue;
      }
    ...
    var datasets = createDatasets(flatData);
    datasets.csv = {
      content: text,
      headlines: headlines,
      lines: arrays
  ...
  function renderCSV(datasets) {
    var flatData = flatDatasets(datasets);
    var headlines = ['label', 'stack', 'value', 'date', 'location'];
    var csvContent = "".concat(headlines.join(','), "\n");
    ...
    for (var index = 0; index < flatData.length; index++) {
      ...
      csvContent += "".concat(components.join(","), "\n");
    }
  ...
  var DatasetCSVCard = /*#__PURE__*/function (_EditableDataviewCard) {
    _inherits(DatasetCSVCard, _EditableDataviewCard);

    var _super = _createSuper(DatasetCSVCard);

    /**
     * Creates a new instance of DatasetCSVCard.
     * @param parent The parental element or a selector (id).
     */
    function DatasetCSVCard(parent) {
      var _this;

      _classCallCheck(this, DatasetCSVCard);

      _this = _super.call(this, parent);

      _this.setTitle('Dataset CSV');

      return _this;
    }

    _createClass(DatasetCSVCard, [{
      key: "download",
      value: function download(content) {
        var filename = this.datasetsController.getFilename();
        var downloadFilename = createDownloadFilename(filename, "datasets");
  ...
  function parseCSVDate(text) {
    var arrays = csvStringToArray(text);
    var datasetLabels = arrays.shift();
    datasetLabels.shift();
    var datasets = [];
    var minLineLength = datasetLabels.length;

    for (var index = 0; index < datasetLabels.length; index++) {
      datasets.push({
    ...
    for (var lineIndex = 0; lineIndex < arrays.length; lineIndex++) {
      ...
      var date = lineArray.shift();

      for (var columnIndex = 0; columnIndex < lineArray.length; columnIndex++) {
  ...
  function dateToItemsRelation(datasets, dateAccess) {
    var flatData = flatDatasets(datasets);
    flatData = combineByDate(flatData);
    var listOfDates = extractDatesFromDatasets(datasets); // verbose_log('listOfDates', listOfDates);
    ...
    var listOfLabels = extractLabelsFromDatasets(datasets);
    return listOfDates.map(function (date) {
      var datasetDate = {
        date: date
      };
      flatData.filter(function (item) {
        return item.date === date;
      }).forEach(function (entry) {
        var _entry$dateTotal;

        datasetDate[entry.dataset] = entry.value;
        datasetDate.total = (_entry$dateTotal = entry.dateTotal) !== null && _entry$dateTotal !== void 0 ? _entry$dateTotal : entry.value;
      }); // addDataset zero values for empty datasets

      for (var index = 0; index < listOfLabels.length; index++) {
        var label = listOfLabels[index];
  ...
  function renderCSVDate(datasets) {
    var dateRelation = dateToItemsRelation(datasets);
    var labels = extractLabelsFromDatasets(datasets);
    var headlines = ["date"];
    ...
    for (var index = 0; index < dateRelation.length; index++) {
      var dateRow = dateRelation[index];
      var csvRow = "".concat(dateRow.date);

      for (var _labelIndex = 0; _labelIndex < labels.length; _labelIndex++) {
        var label = labels[_labelIndex];
        csvRow += ",".concat(dateRow[label]);
      }

      csvContent += "".concat(csvRow, "\n");
    }
  ...
  var DatasetCSVDateCard = /*#__PURE__*/function (_EditableDataviewCard) {
    _inherits(DatasetCSVDateCard, _EditableDataviewCard);

    var _super = _createSuper(DatasetCSVDateCard);

    /**
     * Creates a new instance of DatasetCSVCard.
     * @param parent The parental element or a selector (id).
     */
    function DatasetCSVDateCard(parent) {
      var _this;

      _classCallCheck(this, DatasetCSVDateCard);
    ...
    _createClass(DatasetCSVDateCard, [{
      key: "download",
      value: function download(content) {
        var filename = this.datasetsController.getFilename();
        var downloadFilename = createDownloadFilename(filename, "datasets");
  ...
  var DataViewCard = /*#__PURE__*/function (_UpdatableDataviewCar) {
    _inherits(DataViewCard, _UpdatableDataviewCar);

    var _super = _createSuper(DataViewCard);

    /**
     * Creates a new instance of DataviewCard.
     * @param parent The parental element or a selector (id).
     */
    function DataViewCard(parent) {
      var _this;

      _classCallCheck(this, DataViewCard);

      _this = _super.call(this, parent);
      if (!_this.config) _this.config = {};
      _this.config.updatesHeight = _this.config.updatesHeight || true;
    ...
    _createClass(DataViewCard, [{
      ...
      key: "getDataview",
      value: function getDataview() {// empty
      }
    }]);

    return DataViewCard;
  }(UpdatableDataviewCard);
  var DataViewDateChartCard = /*#__PURE__*/function (_DataViewCard) {
    _inherits(DataViewDateChartCard, _DataViewCard);

    var _super2 = _createSuper(DataViewDateChartCard);

    function DataViewDateChartCard() {
      _classCallCheck(this, DataViewDateChartCard);

      return _super2.apply(this, arguments);
    }

    _createClass(DataViewDateChartCard, [{
      key: "getTitle",
    ...
    return DataViewDateChartCard;
  }(DataViewCard);
  var DataViewDatePlotChartCard = /*#__PURE__*/function (_DataViewCard2) {
    _inherits(DataViewDatePlotChartCard, _DataViewCard2);

    var _super3 = _createSuper(DataViewDatePlotChartCard);

    function DataViewDatePlotChartCard() {
      _classCallCheck(this, DataViewDatePlotChartCard);

      return _super3.apply(this, arguments);
    }

    _createClass(DataViewDatePlotChartCard, [{
      key: "getTitle",
      value: function getTitle() {
    ...
    return DataViewDatePlotChartCard;
  }(DataViewCard);
  var DataViewMapChartCard = /*#__PURE__*/function (_DataViewCard3) {
    _inherits(DataViewMapChartCard, _DataViewCard3);

    var _super4 = _createSuper(DataViewMapChartCard);

    function DataViewMapChartCard() {
      _classCallCheck(this, DataViewMapChartCard);

      return _super4.apply(this, arguments);
    }

    _createClass(DataViewMapChartCard, [{
      key: "getTitle",
      value: function getTitle() {
        return 'Dataview Map';
      }
    ...
    return DataViewMapChartCard;
  }(DataViewCard);
  var DataViewFlatCard = /*#__PURE__*/function (_DataViewCard4) {
    _inherits(DataViewFlatCard, _DataViewCard4);

    var _super5 = _createSuper(DataViewFlatCard);

    function DataViewFlatCard() {
      _classCallCheck(this, DataViewFlatCard);

      return _super5.apply(this, arguments);
    }

    _createClass(DataViewFlatCard, [{
      key: "getTitle",
      value: function getTitle() {
        return 'Flat Data';
      }
  ...
  var DatasetsControllerCard = /*#__PURE__*/function (_DataViewCard) {
    _inherits(DatasetsControllerCard, _DataViewCard);

    var _super = _createSuper(DatasetsControllerCard);

    /**
     * Creates a new instance of DatasetsControllerCard.
     */
    function DatasetsControllerCard(parent) {
      _classCallCheck(this, DatasetsControllerCard);

      return _super.call(this, parent);
    }

    _createClass(DatasetsControllerCard, [{
      key: "datasetsToText",
      value: function datasetsToText(datasets) {
  ...
  DatasetsController.prototype.addListener = function (listener) {
    ...
    if (!listener.update) return exports.lotivis_log("Listener unqualified.");
    if (this.listeners.includes(listener)) return exports.lotivis_log("[lotivis]  Attempt to add listener twice (".concat(listener, ")."));
  ...
  DatasetsController.prototype.removeListener = function (listener) {
    if (!this.listeners) return exports.lotivis_log("No listeners property.");
    var index = this.listeners.indexOf(listener);
    if (index === -1) return exports.lotivis_log("Listener not registered: ".concat(listener));
  ...
  DatasetsController.prototype.notifyListeners = function () {
    var reason = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "none";
    ...
    for (var index = 0; index < this.listeners.length; index++) {
      ...
      if (!listener.update) {
        exports.lotivis_log("Listener unqualified.");
        continue;
      }

      exports.lotivis_log("listener: ".concat(listener));
  ...
  DatasetsController.prototype.resetFilters = function () {
    var notifyListeners = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : true;
    this.filters.locations = [];
    this.filters.dates = [];
    this.filters.labels = [];
  ...
  DatasetsController.prototype.setLocationsFilter = function (locations) {
    var stringVersions = locations.map(function (location) {
    ...
    if (objectsEqual(this.filters.locations, stringVersions)) {
      return exports.lotivis_log("[lotivis]  Location filters not changed.");
    }
  ...
  DatasetsController.prototype.toggleLocation = function (location) {
    var index = this.filters.locations.indexOf(location);
  ...
  DatasetsController.prototype.setDatesFilter = function (dates) {
    var stringVersions = dates.map(function (date) {
      return String(date);
    }).filter(function (item) {
      return item.length > 0;
    });
    if (objectsEqual(this.filters.dates, stringVersions)) return exports.lotivis_log("[lotivis]  Date filters not changed.");
    this.filters.dates = stringVersions;
    this.calculateSnapshot();
    this.notifyListeners("filter-dates");
    exports.lotivis_log("filter-dates:", this.filters.dates);
  };

  DatasetsController.prototype.toggleDate = function (date) {
    var stringVersion = String(date);
    var index = this.filters.dates.indexOf(stringVersion);
  ...
  DatasetsController.prototype.setDatasetsFilter = function (datasets) {
    var stringVersions = datasets.map(function (dataset) {
      return String(dataset);
    }).filter(function (item) {
      return item.length > 0;
    });
    if (objectsEqual(this.filters.labels, stringVersions)) return exports.lotivis_log("[lotivis]  Dataset filters not changed.");
    this.filters.labels = stringVersions;
    this.calculateSnapshot();
    this.notifyListeners("filter-labels");
    exports.lotivis_log("filter-labels:", this.filters.labels);
  };
  /**
  ...
  DatasetsController.prototype.toggleDataset = function (label) {
    var notifyListeners = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : true;
    var index = this.filters.labels.indexOf(label);
  ...
  DatasetsController.prototype.filteredDatasets = function () {
    var filtered = copy(this.datasets);

    if (this.filters.labels && this.filters.labels.length > 0) {
      var datasetFilters = this.filters.labels;
    ...
    if (this.filters.locations && this.filters.locations.length > 0) {
      var locationFilters = this.filters.locations;
      filtered = filtered.map(function (dataset) {
        dataset.data = dataset.data.filter(function (data) {
          return locationFilters.includes(String(data.location));
        }) || [];
        return dataset;
      });
    }
    ...
    if (this.filters.dates && this.filters.dates.length > 0) {
      var dateFilters = this.filters.dates;
      filtered = filtered.map(function (dataset) {
        dataset.data = dataset.data.filter(function (data) {
          return dateFilters.includes(String(data.date));
        }) || [];
        return dataset;
      });
    }

    return filtered.filter(function (dataset) {
  ...
  var DatasetsColorsController = /*#__PURE__*/_createClass(
  /**
   * Creates a new instance of DatasetsColorsController.
   * @param workingDatasets
   * @param stacks
   */
  function DatasetsColorsController(workingDatasets, stacks) {
    _classCallCheck(this, DatasetsColorsController);

    var datasets = workingDatasets;
    var labelToColor = {};
    var stackToColors = {};

    var _loop = function _loop(sIndex) {
      var stack = stacks[sIndex]; // filter datasets for stack

      var filtered = datasets.filter(function (dataset) {
        return dataset.label === stack || dataset.stack === stack;
      });
      var colors = Color$1.colorsForStack(sIndex, filtered.length);
      stackToColors[stack] = colors;

      for (var dIndex = 0; dIndex < filtered.length; dIndex++) {
        labelToColor[filtered[dIndex].label] = colors[dIndex];
      }
    };

    for (var sIndex = 0; sIndex < stacks.length; sIndex++) {
      _loop(sIndex);
    }
  ...
  DatasetsController.prototype.calculateSnapshot = function () {
    ...
    this.snapshot.dates = extractDatesFromFlatData(this.snapshot.datasets).sort(function (left, right) {
      return _this.dateAccess(left) - _this.dateAccess(right);
    });
  ...
  DatasetsController.prototype.calculateAdditionalData = function () {
    var dateAccess = this.dateAccess;
    this.datasets = copy(this.datasets).sort(function (left, right) {
    ...
    this.datasets.forEach(function (dataset) {
      ...
      dataset.data = dataset.data.sort(function (left, right) {
        return left.dateNumeric - right.dateNumeric;
      });
    });
    ...
    this.dates = extractDatesFromDatasets(this.datasets).sort(function (left, right) {
      return dateAccess(left) - dateAccess(right);
    });
  ...
  DatasetsController.prototype.datasetsDidChange = function () {
    if (!this.datasets || !Array.isArray(this.datasets)) {
      exports.lotivis_log("[lotivis]  No datasets.");
      return;
    }
  ...
  DatasetsController.prototype.addDatasets = function (datasets) {
    ...
    if (this.datasets.find(function (dataset) {
      return dataset.label === datasets.label;
    })) {
      throw new Error("DatasetsController already contains a dataset with the same label (".concat(datasets.label, ")."));
    }

    this.cache.invalidate();
    datasets.forEach(function (dataset) {
      return _this.datasets.push(dataset);
    });
    this.datasetsDidChange();
    this.notifyListeners("datasets-update");
  };
  ...
  DatasetsController.prototype.removeDatasets = function (labels) {
    ...
    labels.forEach(function (label) {
      var candidate = this.datasets.find(function (dataset) {
        return dataset.label === label;
      });
      if (!candidate) return;
      var index = this.datasets.indexOf(candidate);
      if (index < 0) return;
  ...
  function createBarStackModel(controller, datasets, dateToItemsRelation) {
    var listOfStacks = extractStacksFromDatasets(datasets);
    ...
    return listOfStacks.map(function (stackName) {
      var datasetsForStack = datasets.filter(function (dataset) {
        return dataset.stack === stackName || dataset.label === stackName;
      });
      var candidatesNames = datasetsForStack.map(function (stackCandidate) {
        return stackCandidate.label;
      });
      var candidatesColors = datasetsForStack.map(function (stackCandidate) {
        return controller.getColorForDataset(stackCandidate.label);
      });
      console.log("candidatesNames", candidatesNames);
      var d3Stack = stack().keys(candidatesNames).order(none).offset(none$1);
      var series = d3Stack(dateToItemsRelation);
      console.log("d3Stack", _typeof(series));
      console.log("d3Stack", Array.isArray(series));
      console.log("d3Stack", series.length); // d3Stack.forEach((entry) => {
  ...
  function combineDatasetsByRatio(datasets, ratio) {
    var copied = copy(datasets);

    for (var index = 0; index < copied.length; index++) {
      var dataset = copied[index];
      var data = dataset.data;
  ...
  function combineDataByGroupsize(data, ratio) {
    ...
    var combined = combineByDate(copy(data));
    var newData = [];

    while (combined.length > 0) {
      var dateGroup = combined.splice(0, ratio);
      var firstItem = dateGroup.first() || {};
      var lastItem = dateGroup.last() || {};
      var item = {};
  ...
  DatasetsController.prototype.getDateDataview = function (groupSize) {
    var cachedDataView = this.getCached("date");
    ...
    this.dateAccess;
    var datasets = copy(this.datasets);
    var enabledDatasets = copy(this.filteredDatasets() || datasets);
    var dataView = {};
    var saveGroupSize = groupSize || 1;
    ...
    dataView.datasetStacks = createBarStackModel(this, datasets, dataView.dateToItemsRelation);
    dataView.datasetStacksPresented = createBarStackModel(this, enabledDatasets, dataView.dateToItemsRelationPresented);
    dataView.max = max$3(dataView.datasetStacksPresented, function (stack) {
      return max$3(stack.series, function (serie) {
        return max$3(serie.map(function (item) {
  ...
  DatasetsController.prototype.getDateDataviewCombinedStacks = function (groupSize) {
    ...
    dataView.datasetStacksPresented = createBarStackModel(this, enabledDatasets, dataView.dateToItemsRelationPresented);
    dataView.max = max$3(dataView.datasetStacksPresented, function (stack) {
      return max$3(stack.series, function (series) {
        return max$3(series.map(function (item) {
          return item["1"];
        }));
      });
    });
  ...
  DatasetsController.prototype.getLocationDataview = function () {
    var cachedDataView = this.getCached("location");
    ...
    var dataView = {};
    var flatData = this.snapshot.flatData;
    var combinedByStack = combineByStacks(flatData);
    var combinedByLocation = combineByLocation(combinedByStack);
    dataView.stacks = this.stacks;
    dataView.combinedData = combinedByLocation;
    dataView.combinedData.forEach(function (item) {
  ...
  exports.DateGermanAssessor = DateGermanAssessor;
  ...
  exports.d3 = index;
  exports.debug = debug;
  exports.lotivis_log_once = lotivis_log_once;
